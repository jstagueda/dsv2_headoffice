...
class Pages{
    ...
    private function _pages($pid = 0){
        switch ($pid) {
			...
			case 20   : $page = "pages/leaderlist/ProductInfo.php"; break;
			...
			#case 177.1  : $page = "pages/leaderlist/loyaltyprodlistuploader.php";  break;
			case 712  : $page = "pages/datamanagement/nationalid_generator.php"; break;
			case 712.1  : $page = "pages/datamanagement/nationalid_dumping.php"; break;
			case 712.2  : $page = "pages/datamanagement/computerdsfrfuploader.php"; break;
            ...
            case 107  : $page = "pages/sales/bir/index.php"; break;
            ...
            // case 111  : $page = "pages/leaderlist/leaderlist_linkpromobranch.php"; break;
            ...
            case 127  : $page = "pages/leaderlist/leaderlist_linkpromobranch.php"; break;
            ...
            case 148  : $page = "pages/sales/sales_backOrderReport.php"; brwaeak;
			...
			case 180.1  : $page = "pages/sfm/bmmngt_candidacystatus2.php";  break;
			case 180.2 : $page = "pages/sfm/bmmngt_candidacystatusDetails.php"; break;

			case 180.3  : $page = "pages/sfm/bmmngt_profile.php";  break;
			case 180.4 : $page = "pages/sfm/bmmngt_Details.php"; break;
			
			case 180.5  : $page = "pages/sfm/bmmngt_affliation.php";  break;
			case 180.6 : $page = "pages/sfm/bmmngt_AFFDetails.php"; break;
			
			case 180.7  : $page = "pages/sfm/bmmngt_endorsement.php";  break;
			case 180.8 : $page = "pages/sfm/bmmngt_bmcendorsementdtl.php"; break;
			...
			case 206 : $page = "pages/bpm/HeadofficesSalesRegister.php"; break;
						...
						case 516 : $page = "pages/sales/salesCollectionDueReport.php"; break;
            ...
            case 204 : $page = "pages/sfpm/sfpm_main.php"; break;
						...
						case 509 : $page = "pages/sfm/StatementOfAccount.php"; break;
			...
			case 604 : $page = "pages/sfpm/bcb_main.php"; break;
                        ...
                        case 605 : $page = "pages/sfpm/sfandrfreport.php"; break;
			...
			case 520 : $page = "pages/datamanagement/reasons.php"; break;
                        ...
                        case 300 : $page = "pages/sfm/sfmSalesForceMasterList.php"; break;
                        case 301 : $page = "pages/datamanagement/UserInterfaceFileGenerator.php"; break;

                        case 302 : $page = "pages/leaderlist/createspecialpromo.php"; break;
                        case 303 : $page = "pages/inventory/invIntransitReport.php"; break;
                        case 304 : $page = "pages/sales/salesProductSubstitute.php"; break;
                        case 305 : $page = "pages/sales/salesAdvancePORegister.php"; break;
                        case 306 : $page = "pages/leaderlist/promo_viewspecialpromo.php"; break;
                        case 307 : $page = "pages/leaderlist/leaderlist_linkProductSubstitute.php"; break;
                        case 308 : $page = "pages/datamanagement/view_systemlogs.php"; break;
						
						case 310 : $page = "pages/sfpm/sfmIBMSalesPerformance.php"; break;
						case 311 : $page = "pages/sfpm/sfmIBMSalesReport.php"; break;
						case 312 : $page = "pages/sfpm/sfmDealerSalesReport.php"; break;

                        case 320 : $page = "pages/datamanagement/SyncLogs.php"; break;
                        case 321 : $page = "pages/access_rights/create_modulecontrol.php"; break;
						case 322 : $page = "pages/bpm/HeadofficesSalesRegister.php"; break;
						
						case 340 : $page = "pages/datamanagement/TransferDealerToOtherBranch.php"; break;
						case 341 : $page = "pages/sfm/CreditLimitRegister.php"; break;
						case 342 : $page = "pages/datamanagement/DMCMandCollectionReceiptReason.php"; break;
						
						//case 343 : $page = "pages/sfm/DeliquentAccount.php"; break;  ////************************
						case 343 : $page = "pages/sfm/DeliquentAccount.php"; break;  ////************************
						case 344 : $page = "pages/datamanagement/Setting.php"; break;
						case 345 : $page = "pages/datamanagement/tpi_document/index.php"; break;
						case 346 : $page = "pages/datamanagement/tpi_document/create.php"; break;
						case 347 : $page = "pages/datamanagement/SICancellationForCMG.php"; break;
						case 348 : $page = "pages/datamanagement/CSP/index.php"; break;
						case 349 : $page = "pages/sales/ProvisionalReceiptRegister.php"; break;
						case 350 : $page = "pages/inventory/ReservationReport.php"; break;
                        case 365 : $page = "user/index.php";break;
						
						case 408 : $page = "user/unlockuser.php";break;
						case 412 : $page = "user/changepassword.php"; break;
						
                        case 700 : $page = "pages/sfm/sfmOnlineTopSellersReport.php"; break;
                        case 701 : $page = "pages/sales/salesOfficialReceiptRegister.php"; break;
						case 703 : $page = "pages/sales/sales_customerDGSReport.php"; break;						
						case 704 : $page = "pages/sfm/IBMServiceFreeReport.php"; break;
						case 705 : $page = "pages/sales/CSP/index.php"; break;				
						case 706 : $page = "pages/datamanagement/Reservation.php"; break;
						case 707 : $page = "pages/sfm/sfm_DALupload.php"; break;
						case 708 : $page = "pages/datamanagement/manualposting_rho.php"; break;
						case 709 : $page = "pages/datamanagement/datamgt_RHOtoreservation.php"; break;
						
						case 710 : $page = "pages/sales/salesLoyaltyProgramListRpt.php"; break;
						case 711 : $page = "pages/sfpm/BMmasterlistreport.php"; break;
						case 714 : $page = "pages/sfpm/BMCmasterlistreport.php"; break;
						case 713 : $page = "pages/datamanagement/promodump.php"; break;
						case 715 : $page = "pages/sfpm/CONSOSFRF_Report.php"; break;
						case 716 : $page = "pages/sfpm/SIDMonitoring_Report.php"; break;
						case 719 : $page = "pages/datamanagement/SIDLoadingErrorLog_Report.php"; break;
						case 720 : $page = "pages/datamanagement/SIDDocNoMonitoring_Report.php"; break;
						case 717 : $page = "pages/datamanagement/datamgt_manualdatadump.php"; break;
						case 718 : $page = "pages/datamanagement/datamgt_priceuploading.php"; break;
						case 721 : $page = "pages/sales/grossmarginreport.php"; break;	
						case 722 : $page = "pages/leaderlist/promo_entitlement_report.php"; break;
						case 723 : $page = "pages/sales/dailysalestracking.php"; break;	
						case 724 : $page = "pages/sales/promocodeperformance.php"; break;
						case 725 : $page = "pages/sales/historicalsales.php"; break;							
						case 726 : $page = "pages/sales/newproduct_ytdperformance.php"; break;							
						
						case 730 : $page = "pages/sales/arrecon_report.php"; break;	
						case 740 : $page = "pages/datamanagement/w2wfileuploader.php"; break;
						case 750 : $page = "pages/inventory/w2w_report.php"; break;
						
						case 760   : $page = "pages/inventory/inv_w2wconfirmation.php"; break;
                        case 760.1 : $page = "pages/inventory/inv_w2wdetails.php"; break;
