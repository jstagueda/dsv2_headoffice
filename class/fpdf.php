...
function FPDF($orientation='P',$unit='mm',$format='A4')
{
	...
	if(is_string($format))
	{
		...
		elseif($format=='mine') $format=array(841.89,841.89);
		elseif($format=='mine2') $format=array(1190.55,841.89);
		elseif($format=='or') $format=array(612,252);
		elseif($format=='bir') $format=array(841.89,875.00);
