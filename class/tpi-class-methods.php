...
//echo '<font color="red" size="2"><pre>';var_dump($_SERVER);echo '</font></pre>';
?>
<?php if($_SERVER['REMOTE_ADDR']=='10.132.54.139'): //$dev1_cm->spCheckifAdvPO2(); ?>

<?php /* ?>
<form action="" method="post">
  <input type="button" id="testing" name="testing" value="Testing" onclick="load_areas_under_me(179, 4);" />
</form>
<?php */ ?>
<?php endif; ?>