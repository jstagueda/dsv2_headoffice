...
dTree.prototype.node = function(node, nodeId) {
	...
	if (node.url) {
		...
		str += '<a id="s' + this.obj + nodeId + '" class="linkLeftSubPanel2" href="' + node.url + '"';
		...
		if (this.linkLeftSubPanel2 && ((node._hc && this.config.folderLinks) || !node._hc))
		...
		str += '<a href="javascript: ' + this.obj + '.o(' + nodeId + ');" class="linkLeftSubPanel2">';
