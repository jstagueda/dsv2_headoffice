...
$(function($){
    ...
    $('#SFM-promotionForm').on('submit', function(e){
        ...
        var action = self.find('input[name="SFEpaction"]').val();
        ...
        ppost_gen = {'SFLfrom':select_from, 'SFLto':select_to, 'moveType':'PROMOTION', 'action':'generate'};
        ppost = {'action' : action};
    ...
    initActionMovementProceed('PROMOTION');
    initActionMovementCheckbox();
    getLevelsForSelect('promotion-SFL-from','promotion-SFL-to');
