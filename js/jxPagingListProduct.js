...
var xmlHttp2
var xmlHttp3
function showPage(str, id, search) 
{ 
	//Function that gets called
	//Currently we only call one other sub, but this could change
	showStates(str, id, search)
}

function showStates(str, id, search) 
{ 
	...
	var url="includes/jxPagingListProduct.php"
	url=url+"?p="+str
	url=url+"&t=nav"
...
function stateChanged() { 
	//document.getElementById("pgContent").innerHTML="<div style='text-align:center; padding:10px;'>Loading... Please wait..</div>";
