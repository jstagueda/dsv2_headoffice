...
var xmlHttp2
var xmlHttp3
function showPage(str, wid, plid, search, statid, age, dteAsOf) 
{ 
	//Function that gets called
	//Currently we only call one other sub, but this could change
	
	showStates(str, wid, plid, search, statid, age, dteAsOf)
}

function showStates(str, wid, plid, search, statid, age, dteAsOf) 
{
	...
	var url="includes/jxPagingItemAgingReport.php"
	url=url+"?p="+str
	url=url+"&t=nav"
