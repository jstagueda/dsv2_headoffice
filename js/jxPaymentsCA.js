...
{ 
	...
	*/
	...
	dlen = document.frmValuationReport.cboCustomer.length
	...
	for (x = 0; x < dlen; x++) {
		if(document.frmValuationReport.cboCustomer[x].selected) {
			dealerid = document.frmValuationReport.cboCustomer[x].value
		}
	}
	...
	// HTTP 1
	var url="includes/jxPaymentsCA.php"
	url=url+"?p="+str
	url=url+"&t=con"
	url=url+"&b="+branchid
	url=url+"&d="+dealerid
