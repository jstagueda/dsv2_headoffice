...
var xmlHttp2
var xmlHttp3
function showPage(str, bin, bin2) { 
	//Function that gets called
	//Currently we only call one other sub, but this could change

	showStates(str, bin, bin2)
}

function showStates(str, bin, bin2) { 
	...
	var url="includes/jxPagingViewStepLevelPromo.php"
	url=url+"?p="+str
	url=url+"&t=nav"
...
{
	var objWin;
		popuppage = "pages/leaderlist/promo_steplevelDetails.php?prmsid=" + objID;
