...
var xmlHttp2
var xmlHttp3
function showPage(str, fdate, tdate, code) { 
	//Function that gets called
	//Currently we only call one other sub, but this could change

	showStates(str, fdate, tdate, code)
}


function showStates(str, fromdate, todate, code) { 
	...
	var url="includes/jxPagingViewPerformPromoValidation.php"
	url=url+"?p="+str
	url=url+"&t=nav"
