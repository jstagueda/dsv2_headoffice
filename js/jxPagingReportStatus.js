...
function showStates(str, 
	...
	var url="includes/jxPagingReportStatus.php"
	url=url+"?p="+str
	url=url+"&t=nav"
...
function openPopUp(obj1,obj2,obj3,obj4,obj5,obj6,obj7,obj8) 
{

	var objWin;
	
		popuppage = "pages/inventory/invProductReportStatus_print.php?search="+obj1+"&wid="+obj2+"&lid="+obj3+"&pmgid="+obj4+"&isId="+obj5+"&plid="+obj6+"&refno="+obj7+"&fromdate="+obj8;
...
function getSelectionProductList(text, li) 
{
	...
	tmp = li.id;
	tmp_val = tmp.split("_");
//	h = eval('document.frmValuationReport.hProdID' + ctr);
//	i = eval('document.frmValuationReport.txtProdCode' + ctr);
//	j = eval('document.frmValuationReport.txtProdDesc' + ctr);
//	k = eval('document.frmValuationReport.txtQty' + ctr);
