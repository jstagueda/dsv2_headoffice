...
var xmlHttp2
var xmlHttp3
function showPage(str, bin, wid) { 
	//Function that gets called
	//Currently we only call one other sub, but this could change

	showStates(str, bin, wid)
}

function showStates(str, bin, wid) { 
	...
	var url="includes/jxPagingORTxnRegister.php"
	url=url+"?p="+str
	url=url+"&t=nav"
...
function openPopUp(obj, obj2, obj3) 
{
	var objWin;
	popuppage = "pages/sales/sales_dccrprint.php?f="+ obj + "&t=" + obj2 + "&s=" + obj3;
