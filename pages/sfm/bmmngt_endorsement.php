...
<script type="text/javascript" src="js/jxbmcendorsement.js?rand=<?php echo $sessionUniqueID?>"></script>

<?php include IN_PATH.DS."scBMAFF.php";?>
    ...
    <tr>
        <td valign="top">
            ...
            <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
                <tr>
                    <td class="txtgreenbold13">BM-C ENDORSEMENT</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
            <br />
