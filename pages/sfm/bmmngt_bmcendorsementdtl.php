<?php
	...
	include IN_PATH.'scbmmgt_endorsement.php'; 
...
<form name="frmConfirmReceiptDetails" method="post" action="index.php?pageid=180.8&tid=<?php echo $_GET['tid'];?>">
	...
	<tr>
    	<td valign="top">
      		...
      		<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
                <tr>
                    <td class="txtgreenbold13">BM Information(BM-C Endorsement)</td>
                    <td>&nbsp;</td>
                </tr>
			</table>
			<br />
			...
			<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="tabmin2">
                        <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1">
                            <tr>
                                <td class="txtredbold">Additional Branch</td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
                    </td>
