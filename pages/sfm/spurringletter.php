...
$(document).ready(function(){
	...
	$("#Generatelist").click(function(){
		...
		if($("#search_dealer_to").val() != ""){
				if($("#search_dealer").val() == ""){
					show_error +="*Required Dealer from.\n";
					$("#search_dealer").focus();
					count_err++;
				}
		}
		...
		/*
			"past_due_from" : $("#past_due_from").val();
			"past_due_to" : $("#past_due_to").val();
		*/
			...
			$.ajax({
				...
				url: 'pages/sfm/param_ajax_calls/spurring_letter_call_ajax.php',
...
function dealer_search()
{
	...
	$('#search_dealer').autocomplete({
		source:'pages/sfm/param_ajax_calls/spurring_letter_call_ajax.php',
...
function dealer_search_to()
{	
	//alert($("#search_dealer").val());
	
	$('#search_dealer_to').autocomplete({
		source:'pages/sfm/param_ajax_calls/spurring_letter_call_ajax.php',
			select: function( event, ui ) {
				$( "#search_dealer_to").val(ui.item.Code);
...
<form method="post" action="pages/sfm/spurringletterprint.php">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<table width="95%" border="0" align="center" cellpadding="0"
					cellspacing="1">
					<tr>
						<td class="txtgreenbold13">Spurring Letter</td>
						<td>&nbsp;</td>
					</tr>
				</table>	
		</table>
