...
<script type="text/javascript" src="js/jxBMprofile.js?rand=<?php echo $sessionUniqueID?>"></script>

<?php include IN_PATH.DS."scBMprofile.php";?>
    ...
    <tr>
        <td valign="top">
                    ...
                    <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1">
                        <tr>
                            <td width="70%" align="right">&nbsp;
                                <a href="javascript:void(0);" onclick="return leavepage(71);" class="txtblueboldlink" align = "right">Leave Page</a>|
            ...
            <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
                <tr>
                    <td class="txtgreenbold13">BM-F Update Profile Details</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
            <br />
            ...
            <div style="width:95%; margin:0 auto;">
			    <?php 
			     ...
			     <div style="width: 750px; float:right ; "  >
                       <div class="tbl-head-content-center tbl-float-inherit" style="width: 750px; float:right ; " >
					   ...
					   <table width="100%" >
					     <tr>
                            <td >&nbsp;</td>
                             <td colspan = 10 ><b><?php echo $message ?> </b></td>
                            <td class="tabmin3">&nbsp;</td>
                        </tr>
			          </table>
					  </div> 
                ...
                <div style="float:left; width:540px;">
                    ...
                    <div class="formwrapper">
                        <form action="" method="post" name="formibmsalesreport" onload=" ">
                        <table width="100%">
							<tr>
                                ...
                                <td>
                                    ...
                                    <input name="branch" type="hidden" class="txtfield" value ="<?php echo  $_GET['branch'] ?>">
                                </td>
                            </tr>
                            <tr>
