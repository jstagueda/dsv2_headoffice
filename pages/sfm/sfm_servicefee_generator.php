...
<script type="text/javascript" src="js/sfm_js/jquery.sfmServiceFeeGenerator.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td valign="top" style="min-height: 610px; display: block;">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="topnav">&nbsp;&nbsp;<span class="txtgreenbold13">Service Fee Generator</span></td>
                </tr>
                <tr>
                    <td>
                        <!-- FORM STARTS HERE -->
                        <div class="tbl-content-div">
                            ...
                            <div class="tbl-head-content-center tbl-float-inherit" style="width: 368px;"><span>Service Fee Actions</span></div>
                            ...
                            <div class="tbl-mid-content tbl-float-inherit" style="width: 354px;">
                                <form class="tbl-float-inherit" id="SFM-SFForm" method="POST" action="">
                                    ...
                                    <div class="tbl-input tbl-float-inherit">
                                        <div class="tbl-input tbl-float-inherit">
                                            <input style="width: 252px;" id="SFCM" name="SFCM" class="txtfield">
                                        </div>
                                    </div>
                                    <div class="tbl-clear clear-xsmall"></div>
                                    ...
                                    <input type="submit" value="Process Service Fee Calculation" id="frmbtnSF" class="btn" name="btnSF">
                        ...
                        <div class="tbl-listing-div">
                            <div class="tbl-head-content-left tbl-float-inherit"></div>
                            <div class="tbl-head-content-center tbl-float-inherit" style="width: 650px;"><span>Service Fee Passer List(s)</span></div>
                            <div class="tbl-head-content-right tbl-float-inherit"></div>
                            <div class="tbl-clear"></div>
