...
<script type="text/javascript" src="js/sfm_js/jquery.sfmMovementReversion.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td valign="top">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="topnav">&nbsp;&nbsp;<span class="txtgreenbold13">Sales Force Movement Reversion</span></td>
                </tr>
                <tr>
                    <td>
                        <!-- FORM STARTS HERE -->
                        <div class="tbl-content-div">
                            ...
                            <div class="tbl-head-content-center tbl-float-inherit" style="width: 368px;"><span>Reversion Actions</span></div>
                            ...
                            <div class="tbl-mid-content tbl-float-inherit" style="width: 354px;">
                                <form class="tbl-float-inherit" id="SFM-reversionForm" method="POST" action="">
                                    ...
                                    <div class="tbl-input tbl-float-inherit">
                                        <select style="width: 252px;" id="eSFLfrom" name="eSFLfrom">
                                            ...
                                            <option class="reversion-SFL-from hide"></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="tbl-input tbl-float-inherit">
                                        <select style="width: 252px;" id="eSFLto" name="eSFLto">
                                            <option value="">Select sales force level here...</option>
                                            <option class="reversion-SFL-to hide"></option>
                                        </select>
                                    </div>
                                    <div class="tbl-clear clear-xsmall"></div>
                                        
                                    <input type="hidden" name="SFEraction" id="SFEraction" value="lists" />
                        ...
                        <div class="tbl-listing-div">
                            <div class="tbl-head-content-left tbl-float-inherit"></div>
                            <div class="tbl-head-content-center tbl-float-inherit" style="width: 650px;"><span>For Reversion List(s)</span></div>
                            <div class="tbl-head-content-right tbl-float-inherit"></div>
                            <div class="tbl-clear"></div>
