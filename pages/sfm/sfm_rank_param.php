...
<script type="text/javascript" src="js/sfm_js/jquery.sfmRank.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td valign="top" style="min-height: 610px; display: block;">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="topnav">&nbsp;&nbsp;<span class="txtgreenbold13">Rank Parameter</span></td>
                </tr>
                <tr>
                    <td>
                        <!-- FORM STARTS HERE -->
                        <div class="tbl-content-div">
                            ...
                            <div class="tbl-head-content-center tbl-float-inherit" style="width: 368px;"><span>Rank Actions</span></div>
                            ...
                            <div class="tbl-mid-content tbl-float-inherit" style="width: 354px;">
                                <form class="tbl-float-inherit" id="SFM-rankForm" method="POST" action="">
                                    ...
                                    <div class="tbl-input tbl-float-inherit"><input disabled="disabled" style="width: 250px;" type="text" id="rcodeID" name="rcodeID" value="" /></div>
                                    ...
                                    <div class="tbl-input tbl-float-inherit"><input style="width: 250px;" name="rdescription" type="text" id="rdescription" value="" /></div>
                                    <div class="tbl-clear clear-xsmall"></div>
                                    
                                    <div class="tbl-lbl tbl-float-inherit">Rank Order:<span class="required-asterisk">*</span></div>
                                    <div class="tbl-input tbl-float-inherit"><input style="width: 50px;" name="rorder" type="text" id="rorder" value="" /></div>
                                    ...
                                    <div class="tbl-input tbl-float-inherit"><input style="width: 100px;" type="text" id="rstartDate" name="rstartDate" value="" /></div>
                                    <div class="tbl-clear clear-xsmall"></div>
                                    <div class="tbl-lbl tbl-float-inherit">To:</div>
                                    <div class="tbl-input tbl-float-inherit"><input style="width: 100px;" type="text" id="rendDate" name="rendDate" value="" /></div>
                                    
                                    <input type="hidden" name="raction" id="raction" value="insert" />
                                    <div class="tbl-clear clear-medium"></div>
                                    <input type="submit" value="Create New Rank" id="frmbtnRank" class="btn" name="btnNewRank">
                        ...
                        <div class="tbl-listing-div">
                            <div class="tbl-head-content-left tbl-float-inherit"></div>
                            <div class="tbl-head-content-center tbl-float-inherit" style="width: 550px;"><span>Ranks List(s)</span></div>
                            <div class="tbl-head-content-right tbl-float-inherit"></div>
                            <div class="tbl-clear"></div>
                            ...
                            <table width="100%" border="1" cellspacing="3" cellpadding="3" style="width: 560px;border-collapse: collapse;border-color: #959F63;">
                                <tr>
                                    ...
                                    <th width="5%" class="td-bottom-border">Order</th>
                                    <th width="20%" class="td-bottom-border">Effective Start Date</th>
                                    <th width="20%" class="td-bottom-border">Effective End Date</th>
                                    <th width="20%" class="td-bottom-border">Delete</th>
                                </tr>
                                
                                <tr class="tbl-td-rows">
                                    <td class="tbl-td-center td-bottom-border" colspan="6">Fetching ranks lists...</td>
                                </tr>
                            </table>
