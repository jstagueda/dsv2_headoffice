...
<script src="js/jxIBMCollectionDue.js" language="javascript" type="text/javascript"></script>
<?php
	//setExpires(0);
	include IN_PATH.DS."scIBMCollectionDue.php";
?>
...
<tr>
	<td valign="top">
		...
		<tr>
  		...
  		<tr>
    		<td class="txtgreenbold13">IBD Collection Due Report</td>
    		<td>&nbsp;</td>
  		</tr>
		</table>
		<br />
		...
		<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
  		<tr>
    		...
    		<table width="50%"  border="0" align="left" cellpadding="0" cellspacing="1" class="bordersolo">
				...
				<tr>
          			<td height="20" align="right"><strong>IBM Code :</strong></td>
          			<td height="20" align="right">&nbsp;</td>
          			<td height="20" align="left">
					<select name="cboIBMfrom" class="txtfield" >
    		...
    		<tr>
    		  <td height="20" align="right"></td>
    		  <td height="20"></td>
    		  <td height="20" align="left"><input name="btnSubmit" type="button" class="btn" value="Submit" onclick="return showPage(0, <?php echo $branchid; ?>,'<?PHP $ibmfrom; ?>','<?PHP $ibmto; ?>', '<?PHP echo $fromdate; ?>', '<?PHP echo $todate; ?>');" /></td>
  		  </tr>
    		<tr>
	...
	<script >
		...
		window.onload = showPage(0, <?php echo $branchid; ?>,'<?PHP $ibmfrom; ?>','<?PHP $ibmto; ?>', '<?PHP echo $fromdate; ?>', '<?PHP echo $todate; ?>');    
	</script>
