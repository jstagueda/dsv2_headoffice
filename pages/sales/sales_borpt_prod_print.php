...
$html='<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td align="center" height="10"><strong>Back Order Report - By Product</strong></td>
        </tr>
        <tr>
...
$query=$tpi->selectBORptByProd($database, $isDetailed, $filterID, $branchID, $fromDate, $toDate, $vProdLine, $vCustCode, $campaignID);
$num=$query->num_rows;	
...
if($query->num_rows!=0) {
  ...
  // Estimated string length of product description when the TCPDF engine will wrap the text, therfore consuming an extra row.   
    ...
    if($j<$numRows) {
      ...
      if($isDetailed=='1') {
        ...
        if($tmpProdID!=$prodID) {
          ...
          $strTable.='<tr align="center" class="tab">
                        <td height="20" class="borderBR" align="center" width="5%">'.$row->prodCode.'</td>
                        <td height="20" class="borderBR" align="center" width="20%">'.$row->prodName.'</td>
                        <td height="20" class="borderBR" align="center" width="12%">'.$row->prodLine.'</td>
                        <td height="20" class="borderBR" align="center" width="5%">'.$row->branchName.'</td>
                        <td height="20" class="borderBR" align="center" width="8%">'.$row->custCode.'</td>
                        <td height="20" class="borderBR" align="center" width="15%">'.$row->custName.'</td>
                        <td height="20" class="borderBR" align="center" width="5%">'.$row->SONo.'</td>
                        <td height="20" class="borderBR" align="center" width="7%">'.$row->TxnDate.'</td>
          ...
          $strTable.='<tr align="center" class="tab">
                        <td height="20" class="borderBR" align="center" width="5%"></td>
                        <td height="20" class="borderBR" align="center" width="20%"></td>
                        <td height="20" class="borderBR" align="center" width="12%"></td>
                        <td height="20" class="borderBR" align="center" width="5%">'.$row->branchName.'</td>
                        <td height="20" class="borderBR" align="center" width="8%">'.$row->custCode.'</td>
                        <td height="20" class="borderBR" align="center" width="15%">'.$row->custName.'</td>
                        <td height="20" class="borderBR" align="center" width="5%">'.$row->SONo.'</td>
        ...
        $strTable.='<tr align="center" class="tab">
                     <td align="center" height="20" class="borderBR">'.$row->prodCode.'</td>
                     <td align="center" height="20" class="borderBR">'.$row->prodName.'</td>
                     <td align="center" height="20" class="borderBR">'.$row->prodLine.'</td>                                                                                                    
                     <td align="center" height="20" class="borderBR">'.$row->totalOrderedQty.'</td>
                     <td align="center" height="20" class="borderBR">'.$row->totalServedQty.'</td>
                     <td align="center" height="20" class="borderBR">'.$row->totalBOQty.'</td>    
                    </tr>';
      }
      
      // Determine if product string length is greater than threshold. If it is, subtract the number of rows per page if necessary.       
      if(strlen($row->prodName)>$productLenThreshold) {
      
        // Subtract the number of rows only if we reached threshold of the number of rows whose string length is greater than product length threshold.         
      ...
      if($isDetailed=='1') {
        ...
        $html='<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">							
                <tr>    
                  <td align="center" height="20" class="bdiv_r">Product Code</td>
                  <td align="center" height="20" class="bdiv_r">Product Description</td>
                  <td align="center" height="20" class="bdiv_r">Product Line</td>                                                                                                    
                  <td align="center" height="20" class="bdiv_r">Total Ordered Qty</td>
                  <td align="center" height="20" class="bdiv_r">Total Served Qty</td>
                  <td align="center" height="20" class="bdiv_r">Total Back Order Qty</td>    
                </tr>'.$strTable.'</table>';
      }        
  ...
  if($cnt==$query->num_rows) {
      ...
      $total='<tr align="center" class="tab">      
                ...
                <td height="20" class="borderBR" align="center" width="7%">'.$tmpOrdered.'</td>
                <td height="20" class="borderBR" align="center" width="7%">'.$tmpServed.'</td>
                <td height="20" class="borderBR" align="center" width="7%">'.$tmpBackOrdered.'</td>
              </tr>';
  } $query->close();
  ...
  $strTable='<tr align="center"><td align="center" height="20" colspan="8"><strong>No record(s) to display.</strong></td></tr>';  
  $html='<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">							
          <tr>
