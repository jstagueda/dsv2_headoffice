...
function openPopUp(branchID, filterID, campaignID, fromdate, toDate, vProdLine, vCustCode) {
	...
	popuppage="pages/sales/sales_borpt_customer_print.php?branchID="+branchID+"&filterID="+filterID+"&campaignID="+campaignID+"&fromdate="+fromdate+"&toDate="+toDate+"&vProdLine="+vProdLine+"&vCustCode="+vCustCode+"&isDetailed="+isDetailed;
...
<?php include(IN_PATH.DS.'scBackOrderRptByCust.php'); ?>
  ...
  <tr>
    <td valign="top">
      ...
      <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
        <tr>
          <td class="txtgreenbold13">Back Order Report - By Customer</td>
          <td>&nbsp;</td>
        </tr>
      </table>
      <br />
      <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
        <tr>
          <td>
            <form name="frmORRegister" method="post" action="index.php?pageid=158&branchID=<?php echo $branchID; ?>">
              <table width="99%"  border="0" align="center" cellpadding="0" cellspacing="1" class="bordersolo">
                ...
                <tr>
                  ...
                  <td height="20">
                    <select name="cboBranch" onchange="MM_jumpMenu('parent', this, 0);" class="txtfield" style="width:160px;">
                      <option value="index.php?pageid=158&branchID=0">[Select Here]</option>
                      <?php $rsBranch=$sp->spSelectBranchByName($database); ?>
                      <?php if($rsBranch->num_rows): while($row=$rsBranch->fetch_object()): ?>
                      <option value="index.php?pageid=158&branchID=<?php echo $row->ID; ?>"<?php echo $_GET['branchID']==$row->ID?' selected="selected"':''; ?>><?php echo $row->Name; ?></option>                                                                                                           
                      <?php endwhile; endif; ?>                                                                                 
                    </select>
                  </td>				 
                </tr>
                ...
                <tr>
                  <td height="20"  class="padr5" align="right">Customer Code :</td>            
                  <td height="20" align="left">
      ...
      <!-- Detailed Back Order Report - By Customer starts here... -->
      <div class="backorder-report detailed-backorder-report">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="tabmin">&nbsp;</td>
            <td class="tabmin2 txtredbold">Detailed Back Order Report - By Customer</td>
            <td class="tabmin3">&nbsp;</td>
          </tr>
        </table>
            ...
            <td valign="top">
              <div class="scroll_500">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1">
                  ...
                  $cnt=0;
                  ?>
                  <?php while($row=$rsDetailedDetails->fetch_object()): $custID=$row->custID; ?>
                  <?php	if($tmpcustID!=$custID): ?>
                  <?php if($cnt!=0): ?>                
                  ...
                  <?php else: ?>                
                  <tr align="center" class="tab">
                    <td height="20" class="borderBR " align="center" width="8%"> </td>
                    <td height="20" class="borderBR " align="center" width="15%"> </td>
                    <td height="20" class="borderBR" align="center" width="5%"><?php echo $row->prodCode; ?></td>
                    <td height="20" class="borderBR" align="center" width="20%"><?php echo $row->prodName; ?></td>
                    <td height="20" class="borderBR" align="center" width="12%"><?php echo $row->prodLine; ?></td>
                    <td height="20" class="borderBR " align="center" width="5%"><?php echo $row->branchName; ?></td>
      ...
      <!-- Detailed Back Order Report - By Customer ends here... -->
      
      <!-- Summarized Back Order Report - By Customer starts here... -->
      <div class="backorder-report summarized-backorder-report">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="tabmin">&nbsp;</td>
            <td class="tabmin2 txtredbold">Summarized Back Order Report - By Customer</td>
            <td class="tabmin3">&nbsp;</td>
          </tr>
        </table>
        <table width="95%" align="center" border="0" cellpadding="0" cellspacing="1" class="bordergreen">                
            ...
            <td valign="top">
              <div class="scroll_500">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1">
                  ...
                  <?php while($row=$rsSummarizedDetails->fetch_object()): ?>                                                   
                  <tr align="center" class="tab">
                    <td height="20" class="borderBR" align="center" width="8%"><?php echo $row->custCode; ?></td>
                    <td height="20" class="borderBR" align="center" width="15%"><?php echo $row->custName; ?></td>                                                                                                                                          
      ...
      <!-- Summarized Back Order Report - By Customer ends here... -->
      
      <br />
      <table width="95%"  border="0" align="center">
        <tr>      		
          <td height="20" align="center">
            <input type="button" name="btnPrint" class="btn" value="Print" onclick="return openPopUp(<?php echo $branchID;?>, <?php echo $filter;?>, <?php echo $campaignID;?>, '<?php echo $fromdate;?>', '<?php echo $todate;?>', '<?php echo $vSearchProdLine;?>', '<?php echo $vSearchProdCode;?>');" />&nbsp;&nbsp;&nbsp;<a class="txtnavgreenlink" href="index.php?pageid=18"><input name="Button" type="button" class="btn" value="Back"></a>
          </td>    
        </tr>
      </table>
    </td>
