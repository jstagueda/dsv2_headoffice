...
<script type="text/javascript" src="js/jxAdvancePORegister.js"></script>
    ...
    <tr>
        <td valign="top" style="min-height: 610px; display: block;">
            ...
            <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
                <tr>
                    <td class="txtgreenbold13">Advance PO Register Report</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
            <br />
                    ...
                    <div class="formwrapper">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td width="3%" align="center">:</td>
                                <td>
                                    <input name="customerfrom" value="" class="txtfield">
                                    <input name="customerfromHidden" value="0" type="hidden" class="txtfield">
                                    -
                                    <input name="customerto" value="" class="txtfield">
                                    <input name="customertoHidden" value="0" type="hidden" class="txtfield">
                                </td>
                            </tr>
                            <tr>
