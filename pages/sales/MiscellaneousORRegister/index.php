...
<script src="js/MiscRegister.js" language="javascript" type="text/javascript"></script>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	...
	<td valign="top">
            ...
            <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
                    <td class="txtgreenbold13">Miscellaneous  Receipt Register</td>
                    <td>&nbsp;</td>
				</tr>
            </table>
            <br />
            ...
            <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" >
				...
				<td align="left">
					...
					<input type = 'hidden' value = '0' name = 'sfmlevel' />
					<input type="hidden" name="sfaccountfrom" class="txtfield">
					<input name="sfaccountfromHidden" type="hidden" value="0">
					<input type="hidden" name="sfaccountto" class="txtfield">
