...
$html='<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td align="center" height="10"><strong>Back Order Report - By Customer</strong></td>
        </tr>
        <tr>
...
$query=$tpi->selectBORptByCustomer($database, $isDetailed, $filterID, $branchID, $fromDate, $toDate, $vProdLine, $vCustCode, $campaignID);
$num=$query->num_rows;	
    ...
    if($j<$numRows) {
      ...
      if($isDetailed=='1') {
        ...
        if($tmpcustID!=$custID) {
          ...
          $strTable.='<tr align="center">
                      <td height="20" align="center" width="8%"> </td>
                      <td height="20" align="center" width="15%"> </td>
                      <td height="20" align="center" width="5%">'.$row->prodCode.'</td>
                      <td height="20" align="center" width="20%">'.$row->prodName.'</td>
                      <td height="20" align="center" width="12%">'.$row->prodLine.'</td>
                      <td height="20" align="center" width="5%">'.$row->branchName.'</td>
        ...
        $strTable.='<tr align="center">
                      <td align="center" height="20">'.$row->custCode.'</td>
                      <td align="center" height="20">'.$row->custName.'</td>                                                                                                                                                        	
                      <td align="center" height="20">'.$row->totalOrderedQty.'</td>
                      <td align="center" height="20">'.$row->totalServedQty.'</td>
                      <td align="center" height="20">'.$row->totalBOQty.'</td>
                    </tr>';
      }
      ...
      if($isDetailed=='1') {
        ...
        $html='<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">							
                <tr>    
                  <td align="center" height="20">Customer Code</td>
                  <td align="center" height="20">Customer Name</td>                                                                                                                		          	
                  <td align="center" height="20">Total Ordered Qty</td>
                  <td align="center" height="20">Total Served Qty</td>
                  <td align="center" height="20">Total Back Order Qty</td>    
                </tr>'.$strTable.'</table>';
      }        
