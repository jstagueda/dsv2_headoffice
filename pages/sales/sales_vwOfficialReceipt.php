<?PHP 
	include IN_PATH.DS."scViewOfficialReceipt.php";
?>

<script src="js/jxPagingOfficialReceipt.js" language="javascript" type="text/javascript"></script>
...
<br />
<form name="frmSalesInvoiceView" action="index.php?pageid=96" method="post">
          	...
          	<td class="">
			  	<?php 
				  	...
				  	if (isset($_GET['orid']))
				  	{
				  		...
				  		$orid = strtolower($_GET['orid']);
					  	echo"
							<script language='Javascript'>
						    blah = window.open('pages/sales/prOfficialReceipt.php?orid=$orid&new=1');
						    </script>";
