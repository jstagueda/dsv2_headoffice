<?PHP 
	// include "pages/sales/bir/ajax.php";
?>
...
<script src="pages/sales/bir/bir.js" language="javascript" type="text/javascript"></script>
<style>
            ...
            <form name="frmbirbackend" method="post" action="index.php?pageid=107">
                ...
                <div class="tbl-input tbl-float-inherit">
					<select name = 'Branch'>
						...
						<?php $q = $database->execute("select * from branch where ID > 3");
							if($q->num_rows):
