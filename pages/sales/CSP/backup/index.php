<script src = "pages/datamanagement/CSP/csp.js">
</script>
<style>
				...
				<table cellspacing="1" cellpadding="0" width="98%" border="0" align="center">
					<tr>
						<td width="70%" align="right">
							<a class="txtblueboldlink" href="index.php?pageid=1">Data Management</a>
						</td>
					</tr>
				</table>
			</td>
	...
	<div style="width:98%; margin:auto;">
		...
		<div>
			...
			<div style="text-align:center;">
				<!-- nput type="button" class="btn" name="btnPrint" value="Print" -->
