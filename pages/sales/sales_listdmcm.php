<?PHP 
include IN_PATH.DS."scViewListDMCM.php";
?>
<script src="js/jxPagingViewListDMCM.js" language="javascript" type="text/javascript"></script>
	...
	<tr>
		<td>
			<?php
				...
				echo "<div align='left' style='padding:5px 0 0 5px;' class='txtredbold'>".$_GET['errmsg']."</div>";
			?>
		</td>
	</tr>
<?php			
...
?>
<tr>
	<td class="txtgreenbold13">List of Debit / Credit Memo</td>
</tr>
</table>
<form name="frmListSO" action="index.php?pageid=49" method="post">
<br />
