...
<script src="js/jxIBDBadDebtsReport.js" language="javascript" type="text/javascript"></script>
<?php
	//setExpires(0);
	include IN_PATH.DS."scIBDBadDebts.php";
?>
...
<tr>
	<td valign="top">
		...
		<tr>
  		...
  		<tr>
    		<td class="txtgreenbold13">IBD Bad Debts</td>
    		<td>&nbsp;</td>
  		</tr>
		</table>
		<br />
