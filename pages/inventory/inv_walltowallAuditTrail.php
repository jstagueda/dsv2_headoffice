...
<tr>
	<td valign="top">
		...
		<tr>
  		...
  		<tr>
    		<td class="txtgreenbold13">Wall to Wall Audit Trail</td>
    		<td>&nbsp;</td>
  		</tr>
		</table>
		<br />
		<form name="frmValuationReport" method="post" action="">
		  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
		    <tr>
		      <td><table width="50%"  border="0" align="left" cellpadding="0" cellspacing="1" class="bordersolo">
		        <tr>
		        ...
		        <tr>
		          ...
		          <td height="20" align="left"><input name="txtStartDates" type="text" class="txtfield" id="txtStartDate" size="20" readonly="readonly" value="" />
		        ...
		        <tr>
		          ...
		          <td width="2%" height="20">&nbsp;</td>
		          <td align="left"><input name="txtStartDate" type="text" class="txtfield" id="txtStartDate2" size="20" readonly="readonly" value="" />
		            <input type="button" class="buttonCalendar" name="anchorStartDate2" id="anchorStartDate2" value=" " />
		            <div id="divStartDate2" style="background-color : white; position:absolute;visibility:hidden;"> </div></td>
	            </tr>
		        <tr>
		          <td align="right"><strong>From Time :</strong></td>
		          <td width="2%" height="20">&nbsp;</td>
		          <td align="left"><select name="cboCampaign" class="txtfield" >
		        ...
		        <tr>
		          ...
		          <td height="20"></td>
		          <td height="20" align="left"><select name="cboCampaign2" class="txtfield" >
		            <option value="0" selected="selected">Select Time</option>
		            </select></td>
	            </tr>
		        <tr>
          ...
          <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1" class="bordergreen" id="tbl2">
            <tr>
              <td valign="top" class="bgF9F8F7"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1">
                <tr>
                  <td valign="top" class="" height="242"><table width='100%' id = 'pgContent' border='0' cellpadding='0' cellspacing='1' class='tab'>
                    <tr align='center'>
                      <td width='20%' height='20' align='left' 	 class='padl5 bdiv_r'><strong>Username </strong></td>
                      <td width='10%' height='20' align='left' 	 class='padl5 bdiv_r'><strong>Date</strong></td>
                      <td width='5%' height='20' align='center'  class='bdiv_r'><strong>Time</strong></td>
                      <td width='10%' height='20' align='center' class='bdiv_r'><strong>Item Code &amp; Desc</strong></td>
                      <td width='10%' height='20' align='center' class='bdiv_r'><strong>Qty to Adjust</strong></td>
                      <td width='10%' height='20' align='center' class='bdiv_r'><strong>Counted Qty</strong></td>
                    </tr>
                  </table></td>
                </tr>
              </table></td>
