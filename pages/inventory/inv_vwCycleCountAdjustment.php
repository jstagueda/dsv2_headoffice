<?PHP 
	include IN_PATH.DS."scViewCycleCountAdjustment.php";
?>
<script type="text/javascript">
	window.history.forward(1);
	</script>
<script src="js/jxPagingCycleCountAdjustment.js" language="javascript" type="text/javascript"></script>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="txtgreenbold13"> List of Cycle Count Adjustments </td>
    <td>&nbsp;</td>
  </tr>
</table>
<br />
<form name="frmAdjustmentView" action="index.php?pageid=59" method="post">
