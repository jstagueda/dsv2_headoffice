<?PHP 
	include IN_PATH.DS."scVwInventoryIn.php";
?>
<script src="js/jxPagingOtherIns.js" language="javascript" type="text/javascript"></script>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="txtgreenbold13">List of Inventory In </td>
    <td>&nbsp;</td>
  </tr>
</table>
<br />
<form name="frmInventoryInView" action="index.php?pageid=30" method="post">
