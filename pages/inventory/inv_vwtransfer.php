<?PHP 
include IN_PATH.DS."scViewTransfer.php";
?>
<script type="text/javascript">
	window.history.forward(1);
	</script>
<script src="js/jxPagingTransfer.js" language="javascript" type="text/javascript"></script>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="txtgreenbold13">List of Transfer </td>
    <td>&nbsp;</td>
  </tr>
</table>
<form name="frmAdjustmentView" action="index.php?pageid=29" method="post">
<br />
