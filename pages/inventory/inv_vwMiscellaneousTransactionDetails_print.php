<?php
	...
	$html = '<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
			<tr>
				<td height="20" align="left">&nbsp;<strong>Miscellaneous Transactions</strong>&nbsp;&nbsp;<strong>Reference No.:</strong>&nbsp;'.$transno.'&nbsp;&nbsp;<strong>Movement Type:   </strong>'.$mtype.'&nbsp;&nbsp;<strong>Transaction Date:   </strong>'.$transdate.'</td>
			</tr>
			</table>
			<br />';
	...
	/*
		...
		<tr>
			<td height="20" align="left"> <strong>Miscellaneous Transactions</strong></td>
		</tr>
		</table>
		<br />
		...
		<tr>
			...
			<td width="30%" height="20" align="left"> '.$mtype.'</td>
		</tr>
		<tr>
			...
			($rowalt % 2) ? $class = "" : $class = "bgEFF0EB";
		   	...
		   	else
		   	{
			    ...
			    $html = '<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
			           	<tr>
							<td width="10%" height="20" align="center"><strong>Line No.</strong></td>
							...
							<td width="9%" height="20" align="center"><strong>SOH</strong></td>
							<td width="9%" height="20" align="center"><strong>UOM</strong></td>
							<td width="9%" height="20" align="center"><strong>Actual Qty</strong></td>
							<td width="18%" height="20" align="center"><strong>Reason</strong></td>								
	...
	$pdf->Output("MicsTransactionDetails.pdf", "I");			
?>