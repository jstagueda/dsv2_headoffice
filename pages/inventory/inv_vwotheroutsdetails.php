<script type="text/javascript">
  ...
  {
	  var elms=document.frmVwOtherOutsDetails.elements;
  ...
  function CheckItem()
  {
	 count = 0;
	 str = '';
	 obj = document.frmVwOtherOutsDetails.elements["chkID[]"];
	 ...
	 document.frmVwOtherOutsDetails.submit();
	 return true;
  }
...
<?PHP 
	include IN_PATH.DS."scVwOtherOutsDetails.php";
?>
<link rel="stylesheet" type="text/css" href="../../css/ems.css">
<form name="frmVwOtherOutsDetails" method="post" action="includes/pcVwOtherOutsDetails.php"  >
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="txtgreenbold13">View Inventory Out</td>
    <td>&nbsp;</td>
  </tr>
</table>
<br />
            ...
            <tr>
			  ...
			  <table width="98%"  border="0" cellspacing="1" cellpadding="0">
                  <tr>
                    ...
                    <td width="500"><input name="txtTxnNo" type="text" class="txtfield" size="30" readonly="yes" value="<?php echo $txnno; ?>"></td>
                  </tr><input name="hTxnID" type="hidden" value="<?php echo $id; ?>">
				  <tr>
                    <td height="20" class="txt10">Transaction Date</td>
                    <td><input name="txtTxnDate" type="text" class="txtfield" size="30" readonly="yes" value="<?php echo $txndate; ?>"></td>
                  </tr>
				  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="txtWarehouse" type="text" class="txtfield" value="<?php echo $warehouse; ?>" size="30" readonly="yes"></td>
				  	...
				  	<tr>
	                    ...
	                    <td><input name="txtInvOutType" type="text" class="txtfield" value="<?php echo $invouttype; ?>" size="30" readonly="yes"></td>
	                </tr><input name="hIOTID" type="hidden" value="<?php echo $invouttypeid; ?>">
                  <tr>
		    ...
		    <table width="100%"  border="0" cellpadding="0" cellspacing="1" class="bgFFFFFF">
		      <?PHP										
			   ...
			   ?>
                ...
                <td width="10%" height="20" class="borderBR">10</td>
                <td width="15%" height="20" class="borderBR">3</td>
		        <!--<td width="15%" height="20" class="borderBR"><?php echo $row->Reason; ?></td>-->
		        </tr>
                <?php 
  	...
  	<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
        <tr>
          ...
          <?PHP
			...
			?>
            <input name="btnCancel" type="button" class="btn" value="Cancel" onclick="window.location.href='index.php?pageid=31'" >
		  </td>
	    </tr>
  </table><br></td>
  </tr>
