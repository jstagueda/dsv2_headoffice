<?PHP 
//include IN_PATH.DS."scViewInventoryCount.php";
(isset($_POST['btnSearch'])) ? $vSearch = $_POST['txtSearch'] : $vSearch = '';
?>
<script src="js/jxPagingRecordInventoryCount.js" language="javascript" type="text/javascript"></script>
...
<br />
<form name="frmRecordInvCountView" action="index.php?pageid=100" method="post">
        ...
        <tr>
		 ...
		 <?php 
			  if (isset($_GET['message']))
			  {
				  ...
				  echo "<div align='left' style='padding:5px 0 0 5px;' class='txtblueboldlink'>".$_GET['message']."</div><br />";
			  } 
