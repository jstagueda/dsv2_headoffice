...
<script src="js/jxPagingListPrintCountTags.js" language="javascript" type="text/javascript"></script>
...
<tr>
	<td valign="top">
		...
		<br />
		<form name="frmRecordInvCountView" action="index.php?pageid=133" method="post">
