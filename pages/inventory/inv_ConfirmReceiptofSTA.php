<?PHP 
	include IN_PATH.DS."scConfirmReceiptOfSTA.php";
	(isset($_POST['btnSearch'])) ? $vSearch = $_POST['txtSearch'] : $vSearch = '';
?>

<script src="js/jxConfirmReceiptOfSTA.js" language="javascript" type="text/javascript"></script>
...
<tr>
	<td valign="top" style="min-height: 610px; display: block;">
		...
		<tr>
  		...
  		<tr>
    		<td class="txtgreenbold13"> List of Inventory In - STA</td>
    		<td>&nbsp;</td>
  		</tr>
		</table>
		<br />
<form name="frmConfirmReceiptfromSTA" action="index.php?pageid=30" method="post">
