<?php
	...
	include IN_PATH."scConfirmIssuanceofSTA_print.php";
	global $database;
	...
	$html = '<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
			<tr>
				<td height="20" align="left">&nbsp;<strong>Issuance of STA</strong>&nbsp;&nbsp;<strong>Movement Type :</strong>&nbsp;'.$invtype.'&nbsp;&nbsp;<strong>STA No.:</strong>&nbsp;'.$docno.'&nbsp;&nbsp;<strong>Reference No. :   </strong>'.$txnno.'</td>
			</tr>
			</table>';
	...
	if ($rs_detailsall->num_rows)
 	{
        ...
        {	 
  		...
  		$strTable1 = '<tr>
                         	...
                         	<td height="20" align="center" width="14%">&nbsp;</td>
                         	<td height="20" align="center" width="30%">&nbsp;</td>
                         	<td height="20" align="center" width="10%">Totals :</td>
                         	<td height="20" align="center" width="9%"><strong>'.$totalQ.'</strong></td>
                         	<td height="20" align="center" width="9%"><strong>'.$totalcQ.'</strong></td>
                         	<td height="20" align="center" width="10%">&nbsp;</td>
                         	<td height="20" align="center" width="13%">&nbsp;</td>
                 	</tr>';
	...
	/*$html = '<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        	<tr>
          		<td height="20" align="center"><strong>Issuance of STA</strong></td>
        	</tr>
        	</table>		
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left" height="20"><strong>Product Details</strong></td>
			</tr>
			</table>					
			<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">							
			<tr align="center">
	...
	$pdf->Output("InventoryInOutIssuanceofSTA.pdf", "I");		
?>