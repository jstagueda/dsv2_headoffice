<?PHP 
	include IN_PATH.DS."scApproveMiscellaneousTransactions.php";
?>
<script type="text/javascript">
	window.history.forward(1);
	</script>
<script src="js/jxPagingApproveMiscellaneousTransactions.js" language="javascript" type="text/javascript"></script>
...
<br />
<form name="frmAdjustmentView" action="index.php?pageid=119" method="post">
