...
<script src="js/jxConfirmIssuanceOfSTA.js" language="javascript" type="text/javascript"></script>
...
<tr>
	<td valign="top" style="min-height: 610px; display: block;">
		...
		<br />
<form name="frmConfirmIssuanceofSTA" action="index.php?pageid=27" method="post">
