...
<?PHP 
	include IN_PATH.DS."scVwCycleCountAdjustmentDetails.php";
?>
...
{
	pagetoprint = "pages/inventory/inv_vwCycleCountAdjustmentDetails_print.php?iaID="+iaID+"";
...
<tr>
	<td valign="top">
		...
		<tr>
      	...
      	<tr>
    		<td class="txtgreenbold13">Confirm Cycle Count Adjustment</td>
    		<?php //<td class="txtgreenbold13">View  Cycle Count Adjustment </td> ?>
    		<td>&nbsp;</td>
  		</tr>
		</table>
		<?php
  			...
  			<td valign="top" class="bgF9F8F7">
            	...
            	<tr>
              		<td width="40%" valign="top">
                		...
                		<tr>
	                    	<input name="hWID" type="hidden" value="<?php echo $wid; ?>">
		  			...
		  			<td width="58%" valign="top">
		            	...
		            	<tr>
                    		...
                    		<td height="20"><?php echo $transno; ?></td>
                  		</tr>
		            	<tr>
                    		<td width="25%" height="20" class="txt10">Transaction Date :</td>
                    		<td width="75%" height="20" class="txt10"><?php echo $transdate; ?></td>
                  		</tr>
                  		<tr>
						...
						<tr>
							<td height="20" valign="top" class="txt10">Remarks :</td>
                  			<td height="20" ><textarea name="txtRemarks" cols="30" rows="3" class="txtfieldnh" <?php echo 'readonly=\"yes\"'; ?>><?php echo $remarks; ?></textarea></td>
                		</tr>
              			</table>
          			</td>
      			</tr>
        ...
        <tr>
        	<td class="tab">
            	...
            	<tr align="center">				
              		<td width="5%" height="20" class="bdiv_r">Count</td>
          ...
          <td valign="top" class="bgF9F8F7"><div class="scroll_300">
          	<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="bgFFFFFF">
				...
				?>
			  	...
			  	<?php if ($row->stat == 6){?>
			  		<input name="txtActQuantity<?php echo $ctr?>" type="text" class="txtfield" style="width:60px; text-align:right" value="<?php echo $row->CreatedQty; ?>" onkeyup="javascript:RemoveInvalidChars(txtActQuantity<?php echo $ctr?>,<?php echo $ctr?>);" />
			  	<?php } else {?>
			...
			<?php 
					...
					else 
					{
						echo "<tr align='center'>
							  <td width='100%' height='20' class='borderBR' colspan='7'><span class='txt10 txtredsbold'>No record(s) to display. </span></td>
							</tr>";                                     
					}
			?>
			</table>
