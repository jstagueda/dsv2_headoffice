...
<?php
	include IN_PATH.'scConfirmReceiptofSTADetails.php';
	global $database;
?>
...
function winSelectProduct() 
{
	...
	subWin = window.open('pages/inventory/inv_ConfirmReceiptofSTAProductList.php?tid=' + tid + '&statid=' + sid + '&prodlist=' + plist ,'newWin','width=600,height=600,scrollbars=yes');
	subWin.focus();
	return false;
}
...
<link rel="stylesheet" type="text/css" href="../../css/ems.css">
<form name="frmConfirmReceiptDetails" method="post" action="index.php?pageid=30.1&tid=<?php echo $_GET['tid'];?>&prodlist=<?php echo $_GET['prodlist'];?>">
	...
	<tr>
    	<td valign="top">
      		...
      		<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
                <tr>
                    <td class="txtgreenbold13">Confirm Receipt of STA</td>
                    <td>&nbsp;</td>
                </tr>
			</table>
			<br />
                                	...
                                	<table width="100%"  border="0" cellspacing="1" cellpadding="0">
                                        ...
                                        <tr>
                                          	<td height="20" class="txt10 fieldlabel">STA No.</td>
                                                <td class="separated">:</td>
                                          	<td height="20"><input name="txtDocNo" type="text" class="txtfieldLabel" id="txtDocNo" style="width:200px;" maxlength="20" readonly="yes" value="<?php echo $docno; ?>"></td>
                                        </tr>			 							            							                                        
            							<tr>
                                          	<td height="20" class="txt10 fieldlabel">Delivery Date</td>
                                                <td class="separated">:</td>
                                           	<td height="20"><input name="txtShipmentDate" type="text" class="txtfieldLabel" id="txtShipmentDate" style="width:200px;" readonly="yes" maxlength="20" value="<?php echo $shipdate;?>"></td>
                                        </tr>
                                        <tr>
                                          	...
                                          	<td height="20">
												...
												<input name="txtWarehouse" type="text" class="txtfieldLabel" id="txtSWarehouse" style="width:200px;" maxlength="20" value="<?php echo $sbranch; ?>" readonly="yes">
                                          	</td>
            							</tr>
            							<tr>
                                          	...
                                          	<td height="20">
												...
												<input name="txtWarehouse" type="text" class="txtfieldLabel" id="txtDWarehouse" style="width:200px;" maxlength="20" value="<?php echo $rbranch; ?>" readonly="yes">
                                          	</td>
            							</tr>
            							<tr>
                                	...
                                	<table width="100%"  border="0" cellspacing="1" cellpadding="0">
										...
										<tr>
                                          	<td height="20" class="txt10 fieldlabel">Reference No.:</td>
                                                <td class="separated">:</td>
                                          	<td height="20"><input name="txtRefNo" type="text" class="txtfieldLabel" id="txtRefNo" style="width:200px;" maxlength="20" value="<?php echo $txnno; ?>" readonly="yes"></td>
                                        </tr>
                                        <tr>
                                          	<td width="20%" height="20" class="txt10 fieldlabel">Transaction Date</td>
                                                <td class="separated">:</td>
                                          	<td width="80%" height="20"><input name="startDate" type="text" class="txtfieldLabel" id="startDate" size="20" readonly="yes" value="<?php if($statid == 6){ echo $datetoday;}else{echo $dateconfirmed;} ?>"></td>
           ...
           <!-- Details -->
            ...
            <tr>
                <td align="center">
                    ...
                    <input name="btnPrint" type="submit" class="btn" onclick="window.open('pages/inventory/inv_ReceiptfromSTA_print.php?tid=<?php echo $_GET['tid']; ?>', 'Prooflist', 'width=900, height=900'); return false;" value=" Prooflist "/>				
                    <?php }else{?>
                      <input name="btnPrint" type="submit" class="btn" onclick="window.open('pages/inventory/inv_ConfirmReceiptfromSTA_print.php?tid=<?php echo $_GET['tid']; ?>', 'print', 'width=900, height=900'); return false;" value=" Print "/>	
                    <?php } ?> 
                    <!--<input name="btnCancel" type="submit" class="btn" value="Cancel" onClick="return confirmCancel();">-->
                    <input name="btnCancel" type="submit" class="btn" value="Back to list" onClick="location.href='?pageid=30'; return false;">
                </td>
            </tr>
            </table>
            <!-- end of details list -->
