...
<script language="javascript" src="js/jxCreateOtherOuts.js"  type="text/javascript"></script>
<?php
	include IN_PATH.'scCreateInventoryOut.php';
?>
	...
	<tr>
    	<td valign="top">
      		...
      		<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
              	<tr>
                    <td class="txtgreenbold13">Create Inventory Out </td>
                    <td>&nbsp;</td>
              	</tr>
            </table>
			<br />
 			<form name="frmInventoryOutDetails" method="post" action="includes/pcOtherOuts.php" >
                			...
                			<tr>
          						<td width="50%" valign="top">
                                	<table width="100%"  border="0" cellspacing="1" cellpadding="0">
           								<tr>
                                          	<td height="20" class="txt10">Inventory Out Type </td>
                                          	<td>
                                                <select name="cboInventoryOutType" style="width:165px; height:20px;" class="txtfield">
                                                    <option value="0">[SELECT HERE]</option>
                                                  	<?php 
                                                      	if ($rs_invouttype->num_rows)
                                                      	{
                                                          	while ($row = $rs_invouttype->fetch_object())	
                                                          	{
                                                              	if ($rs_invouttype == $row->ID) 
																	$sel = "selected";
                                                             	 else 
																 	$sel = "";																
          								...
          								<tr>
                                          	...
                                          	<td><input name="txtRefNo" type="text" class="txtfield" id="txtRefNo" size="20" maxlength="20" value="IO00000012" disabled="yes" /></td>
                                        </tr>    
                                        <tr>
          	...
          	<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
          		<tr>
                    ...
                    <td class="tabmin2">
                    	<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1">
                            <tr>
                              	<td class="txtredbold">Inventory Out Details </td>
                              	<td>
                      		...
                      		<tr>
                        		<td class="tab ">
                                	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="txtdarkgreenbold10">
                                        <tr align="center">
                                            <td width="5%" class="bdiv_r"><input name="chkAll" type="checkbox" id="chkAll" value="1"></td>
                                            <td width="20%" class="bdiv_r">Product Code</td>
                                            <td width="20%" class="bdiv_r">Product Name</td>
                                            <td width="10%" class="bdiv_r">SOH</td>
                                            <td width="10%" class="bdiv_r">UOM</td>
                                            <td width="10%" class="bdiv_r">Quantity</td>							
      		...
      		<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="bordergreen">
        		<!--<tr>
                  	<td height="30" class="bgF9F8F7">
                      	<form name="frmproduct" action="index.php?pageid=27" method="post">
                      	<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1">
                          	<tr>
                                <td width="64" class="txt10"><input name="btnSearch" type="submit" class="btn" value="Go" /></td>
                                <td width="133" align="left" class="txt10">
                                    <input name="txtSearch" type="text" class="txtfield" size="30" value="<?php echo $vSearch; ?>" />
                                </td>
          	...
          	<form name="frmList" method="post" action="includes/pcOtherOuts.php">
          	<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1" class="bordergreen" id="tbl2">
                                ...
                                <div id="dvProductList" class="scroll_300">
                                 	<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="bgFFFFFF">
                                      	...
                                      	<tr class="<?php echo $alt; ?>">
                                            ...
                                            <td width="15%" height="20" class="borderBR padl5"><?php echo $pname; ?></td>
                                            ...
                                            <td width="10%" align="center" class="borderBR"><span class="txt10">
                                          		<select name="cboUOM[]" class="txtfield" style="width:100px;" disabled="yes">
                                            		<?php
                                            			if ($rs_uom->num_rows)
														{
                                            ...
                                            <td width="10%" align="center" class="borderBR">15</td>
                                            <td width="10%" align="center" class="borderBR"><input name="txtquantity[]" type="text" class="txtfield3" size="12" maxlength="20" value="12" ></td>
                                            <td width="10%" align="center" class="borderBR">3</td>
                                            <!--<td width="25%" align="center" class="borderB">
                ...
                <!--<tr class="bgF4F4F6">
                    <td height="20">&nbsp;</td>
                    <td align="right">
                    	<input name="btnAdd" type="button" class="btn" value="Add" onclick="getInventoryOut(this.value, 'ShowThis');"/>
                    </td>
                </tr>-->
			</table>
	  		</form>    
          	...
          	<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
          		<tr>
                    <td align="center">
                        ...
                        <input name="btnRemoveInv" type="button" class="btn" value="Remove" onclick="getInventoryOut(this.value, 'dvInventoryOutDetails');">
                    </td>
          		</tr>
        	</table>
      		<!-- END PRODUCT LIST -->
