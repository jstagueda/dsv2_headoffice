<?PHP 
	include IN_PATH.DS."scConfirmReceiptFromHO.php";
	(isset($_POST['btnSearch'])) ? $vSearch = $_POST['txtSearch'] : $vSearch = '';
?>

<script src="js/jxConfirmReceiptFromHO.js" language="javascript" type="text/javascript"></script>
...
<tr>
	<td valign="top" style="min-height: 610px; display: block;">
		...
		<tr>
  		...
  		<tr>
    		<td class="txtgreenbold13"> List of Inventory In - RHO</td>
    		<td>&nbsp;</td>
  		</tr>
		</table>
		<br />
<form name="frmConfirmReceiptfromHO" action="index.php?pageid=26" method="post">
