...
<br>
<form name="frmProductList" method="post" action="inv_ConfirmReceiptfromHOProductList.php?pline=0&tid=<?php echo $_GET['tid'];?>&statid=<?php echo $_GET['statid'];?>&prodlist=<?php echo $_GET['prodlist'];?>" >
						...
						<td colspan="3">
							...
							<!---<tr>
								...
								<td width="75%" height="20">
									...
									<?php
										echo "<option value='inv_ConfirmReceiptfromHOProductList.php?pline=0' >[SELECT HERE]</option>";	
										if ($rs_productType->num_rows)
										{
											while ($row = $rs_productType->fetch_object())	
											{
												...
												echo "<option value='inv_ConfirmReceiptfromHOProductList.php?pline=".$row->ID."&tid=".$_GET['tid']."&statid=".$_GET['statid']."&prodlist=".$_GET['prodlist']."' $sel >".$row->Name."</option>";
											}
...
<tr>
	<td height="20"><div align="right"><input name="btnAdd" type="submit" class="btn" value="Add" onclick="javascript: confirmAdd('../../index.php?pageid=26.1&tid=' + <?php echo $_GET['tid']; ?> + '&statid=' + <?php echo $_GET['statid']; ?>);"></div></td>
</tr>
</table>
</form>