...
<script language="javascript" type="text/javascript">
  ...
  {
	var x=document.forms["frmCreateOverlaySet"]["txtCode"].value;
	if (x==null || x=="")
  {
  alert("Enter Promo code.");
  redirect_to("index.php?pageid=66&inc=1");	
  return false;
  }
}
...
<form name="frmCreateOverlaySet" method="post" action="index.php?pageid=67">
		...
		<tr>
			<td width="50%">
			    ...
			    <tr>
				    ...
				    <td height="20">&nbsp;&nbsp;<input name="txtDescription" disabled type="text" class="txtfield" id="txtDescription" value="<?php if (isset($_POST['txtDescription'])) { echo $_POST['txtDescription']; } ?>" style="width: 362px;" maxlength="60">
					</td>
			    </tr>
				<tr>
				  	<td height="20"><div align="right" class="txtpallete"><strong>Start Date: </strong></div></td>
				  	<td height="20">&nbsp;
						<input name="txtStartDate" disabled type="text" class="txtfield" id="txtStartDate" size="20" readonly="yes" value="<?php if (isset($_POST['txtStartDate'])) { $tmpsdate = strtotime($_POST['txtStartDate']); $sdate = date("m/d/Y",$tmpsdate); echo $sdate; } else { echo $today; } ?>" onChange="checkEndDate();">
				...
				<tr>
				  	...
				  	<td height="20">&nbsp;
						<input name="txtEndDate" disabled type="text" class="txtfield" id="txtEndDate" size="20" readonly="yes" value="<?php if (isset($_POST['txtEndDate'])) { $tmpedate = strtotime($_POST['txtEndDate']); $edate = date("m/d/Y",$tmpedate); echo $edate; } else { echo $today; } ?>">
				...
				<tr>
				  	<td height="20"><div align="right" disabled class="txtpallete"><strong>Purchase Requirement Type: </strong></div></td>
				  	<td height="20">&nbsp;
				  	<?php if(isset($_SESSION['buyins']))
				  	  ...
				  	  ?>
						<select name="cboPReqtType" disabled class="txtfield" id="cboPReqtType">
				...
				<tr>
				  	...
				  	<td height="20" class="txtpallete">
				  		<input type="radio" name="rdoBReqt" disabled id="rdoBReqt" value="2" >
                                                Selection	
					</td>
				</tr>	
				<tr>
				  	...
				  	<td height="20" align="left" class="txtpallete">
				  		...
				  		Criteria:
				  		&nbsp;
				  		<select name="cboPHCriteria" disabled class="txtfield" id="cboPHCriteria" style="width: 150px;">
				...
				<tr>
				  	...
				  	<td height="20" align="left" class="txtpallete">
				  		...
				  		Minimum Value:
				  		&nbsp;
				  		<input name="txtPHMinimum" disabled type="text" value="<?php if (isset($_POST['txtPHMinimum'])) { echo $_POST['txtPHMinimum']; } ?>" class="txtfield" style="width: 150px">
					</td>
				</tr>	
				<tr>
				  	<td height="20">&nbsp;</td>
				  	<td height="20" class="txtpallete">
				  		<input type="radio"  name="rdoBReqt" id="rdoBReqt" value="1" disabled>
			...
			<td width="50%" valign="top">
				    	...
				    	if($rs_gsutype->num_rows)
						{
							while($row = $rs_gsutype->fetch_object())
							{
								...
								echo "<tr>
				    						...
				    						<td width='75%' height='20'>&nbsp;<input type='text' disabled class='txtfield' name='$txt' value='$val' onkeyup='javascript:RemoveInvalidChars($txt);'></td>
				    				</tr>";
							}
							$rs_gsutype->close();
						}
			    ...
			    <tr>
				    ...
				    <td height="20"><input disabled type="checkbox" name="chkPlusPlan" value="1" ></td>
				</tr>
				</table>
			</td>
		</tr>
				...
				<tr>
					<td>
					    ...
					    <tr>
						    ...
						    <td height="21">&nbsp;
						    	<select name="cboRange" style="width:150px; height:20px;" class="txtfield" disabled>
					    ...
					    <tr>
						    ...
						    <td height="22">&nbsp;
						    	<input name="txtCriteria" type="text" disabled class="txtfield" id="txtCriteria" style="width: 150px;" value="" />
						    	...
						    	<br>&nbsp;
						    	<input name="txtCDescription"  disabled type="text" class="txtfield" id="txtCDescription" style="width: 250px;" value="" readonly="yes" />
					    ...
					    <tr>
						    ...
						    <td height="22">&nbsp;
						    	<select name="cboCriteria" disabled class="txtfield" id="cboCriteria" style="width: 150px;" disabled="yes">
									<option value="1">Quantity</option>
									<option value="2">Amount</option>
							</select>
						    </td>
					    ...
					    <tr>
						    ...
						    <td height="22">&nbsp;&nbsp;<input disabled name="txtMinimum" type="text" value="" class="txtfield" style="width: 150px" disabled="yes"></td>
					    </tr>
					    <tr>
						    <td height="22"><div  align="right" class="txtpallete"><strong>Start Date :</strong></div></td>
						    <td height="22">&nbsp;
						    	<input name="txtSetStartDate" disabled type="text" class="txtfield" id="txtSetStartDate" size="20" style="width: 150px" readonly="yes" value="<?php echo $today; ?>">
					    ...
					    <tr>
						    ...
						    <td height="22">&nbsp;
						    	<input name="txtSetEndDate" disabled type="text" class="txtfield" id="txtSetEndDate" size="20" style="width: 150px" readonly="yes" value="<?php echo $end; ?>">
	...
	<td width="47%" valign="top">
		...
		<tr align="center">
			<td height="25" class="borderBR"><div align="left" class="padl5 txtpallete">
				<strong>Type :</strong>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<select name="cboType" disabled class="txtfield" id="cboType" style="width: 100px;" onChange ="selection();"">>
				...
				&nbsp;
				<input name="txtTypeQty" type="text" disabled class="txtfield" id="txtTypeQty" style="width: 60px; text-align: right;">
			</div></td>
		</tr>
		<tr>
			<td valign="top" class="bgF9F8F7">
				...
				<div class="scroll_400">
					...
					<tr align="center">				
					    <td width="10%" height="20" class="borderBR">
						 <input name="btnRemove1" disabled type="button" class="btn" value="Remove" onclick="deleteRow2(this.parentNode.parentNode.rowIndex)">						
						</td>
						...
						<td width="12%" height="20" class="borderBR"><div align="left" class="padl5">
							<input name="txtEProdCode1" disabled type="text" class="txtfield" id="txtEProdCode1" style="width: 80%;" value=""/>
...
<!--							<input name="hEpmgid1" type="hidden" id="hEpmgid1" value=""/>-->
						...
						<td width="31%" height="20" class="borderBR"><div align="left" class="padl5"><input name="txtEProdDesc1" disabled type="text" class="txtfield" id="txtEProdDesc1" style="width: 95%;" readonly="yes" /></div></td>			
						<td width="12%" height="20" class="borderBR"><div align="center">
							<select name="cboECriteria1" disabled class="txtfield" id="cboECriteria1" style="width: 80%;">
								<option value="2" selected="selected">Price</option>
								<option value="1">Quantity</option>
							</select>
						</div></td>
						<td width="12%" height="20" class="borderBR"><div align="center"><input name="txtEQty1" disabled type="text" class="txtfield" id="txtEQty1"  value="1" style="width: 50%; text-align:right" onKeyPress='return disableEnterKey(this, event, 1)'/></div></td>
...
<!--						<input name="txtPmg1" type="text" id="txtPmg1" class="txtfield" readonly="readonly"  style="width: 130px; text-align:left" value=""/>-->
							...
							<select name="cboEPMG1" disabled class="txtfield" id="cboEPMG1" style="width: 80%;">
								<?php
									if($rs_pmg->num_rows)
									{
...
<tr>
     <td align="right">
		<input name='btnSave' disabled type='submit' class='btn' value='Save' onclick='return confirmSave();'>
     </td>
     </form>
	<td align="left">
