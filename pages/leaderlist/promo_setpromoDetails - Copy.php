		...
		<tr>
			<td width="50%">
				...
				<tr>
				    ...
				    <td height="20"><input name="txtCode" type="text" class="txtfieldLabel" id="txtCode" value="<?php if (isset($_POST['txtCode'])) { echo $_POST['txtCode']; }else{echo $promocode;} ?>" size="30"></td>
			    </tr>
			    <tr>
				...
				<tr>
				  	...
				  	<td height="20">
				  		...
				  		onClick="return enableFields();">Selection	
					</td>
				</tr>	
				<tr>
				  	<td height="20">&nbsp;</td>
			...
			<td valign="top" class="bgF9F8F7">
				...
				<tr>
					<td>
						...
						<tr>
						    <td height="20"><div align="left" class="padl5"><strong>Overlay No. :</strong></div></td>
						    <td height="20"><?php echo $buycnt + 1; ?></td>
					    </tr>
					    <tr>
			...
			<td valign="top" class="bgF9F8F7">
				...
				<tr>
					<td>
						...
						<tr align="center">
						    <td width="5%" height="20" class="borderBR"><div align="center"><input name="chkAll" type="checkbox" id="chkAll" value="1"  onclick="checkAll(this.checked);"></div></td>
									<td width="10%" height="20" class="borderBR"><div align="center">Overlay No.</div></td>
									<td width="27%" height="20" class="borderBR"><div align="left" class="padl5">Selection</div></td>
									...
									<td width="10%" height="20" class="borderBR"><div align="center">PMG</div></td>
								...
								if (sizeof($_SESSION['buyin']))
								{
									...
									for ($i=0, $n=sizeof($buyin_list); $i < $n; $i++ ) 
									{
										...
										echo "<tr align='center' id='captionRow$cntr' class='$class'>		
												...
												$cntr</div></td>
												<td width='27%' height='20' class='borderBR'><div align='left' class='padl5'>
												...
												$criteria</div></td>			
												<td width='10%' height='20' class='borderBR'><div align='center' class='padr5'>
	...
	<td width="47%" valign="top">
		...
		<tr align="center">
			<td height="25" class="borderBR"><div align="left" class="padl5">
				...
				&nbsp;
				<input name="txtTypeQty" type="text" class="txtfield" id="txtTypeQty" <?php if($entType == 1){ ?> readonly="readonly"  <?php }?> value="<?php echo $entQty; ?>" style="width: 60px; text-align: right;">
			</div></td>
		</tr>
		<tr>
			<td valign="top" class="bgF9F8F7">
				...
				<tr align="center" class="$class">
					<td width="11%" height="20" class="borderBR"><input name="btnRemove<?php echo $linecnt; ?>" type="button" class="btn" value="Remove" onclick="deleteRow2(this.parentNode.parentNode.rowIndex)"></td>
						<?php
						 ...
						 ?>
					<td width="30%" height="20" class="borderBR"><div align="left" class="padl5"><input name="txtEProdDesc<?php echo $linecnt; ?>" type="text" class="txtfield" id="txtEProdDesc<?php echo $linecnt; ?>" style="width: 220px;" readonly="yes"  value=""/></div></td>			
					<td width="10%" height="20" class="borderBR"><div align="center">
						<select name="cboECriteria<?php echo $linecnt; ?>" class="txtfield" id="cboECriteria<?php echo $linecnt; ?>" style="width: 80px;">
