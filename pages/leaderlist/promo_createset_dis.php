...
<form name="frmCreateSet" method="post" action="index.php?pageid=67.3">
		...
		<tr>
			<td width="50%">
				...
				<tr>
				  	...
				  	<td height="20">&nbsp;
				  	<?php if(isset($_SESSION['buyinss']))
				  	  {
					  	  if (sizeof($_SESSION['buyinss']))
							   {
								$buyin_list = $_SESSION["buyinss"];
								$rowalt=0;
				...
				<tr>
					<td>
						...
						<tr>
							...
							<tr>
								<td height="20"><div  align="right" class="txtpallete"><strong>Incentive No. :</strong></div></td>
								<td height="20" class="txtredbold">&nbsp;&nbsp;<?php echo $ctr; ?></td>
							</tr>                                             
					    <tr>
						    <td height="21"><div  align="right" class="txtpallete"><strong>Range :</strong></div></td>
						    <td height="21">&nbsp;
						    	<select name="cboRange" style="width:150px; height:20px;" class="txtfield" onChange="document.frmCreateSet.submit();">
					    ...
					    <tr>
						    ...
						    <td height="22">&nbsp;
						    	...
						    	<script type="text/javascript">							
								 //<![CDATA[
								 	var a = eval('document.frmCreateSet.hRangeID');
						...
						<tr>
							<td>
								...
								<tr align="center">
									...
									<td width="15%" height="25" class="txtpallete borderBR"><div align="center">Incentive No.</div></td>								
...
<tr>
	...
	<td align="left">
		<form name="frmViewSetPromo" method="post" action="index.php?pageid=66&inc=2">
