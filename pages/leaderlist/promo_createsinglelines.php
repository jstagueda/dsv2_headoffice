...
<form name="frmCreateSingleLine" method="post" action="index.php?pageid=61">
		...
		<tr>
			<td>
				...
				<tr>
					...
					&nbsp;Click to verify Promo Code if Exist.&nbsp;<input name='btnVerify' type='submit' class='btn' onclick='return confirmVerify();' value="Verify"></td>
			    </tr>
			    <tr>
				...
				<tr>
					<td>
						...
						<tr align="center">
							...
							<td width="10%" height="20" class="txtpallete borderBR"><div align="center">Line No.</div></td>
							<td width="12%" height="20" class="txtpallete borderBR"><div align="center">Item Code</div></td>
							<td width="30%" height="20" class="txtpallete borderBR"><div align="left">&nbsp;&nbsp;Item Description</div></td>			
				...
				<div class="scroll_150">
					...
					<tr align="center">
						...
						<td width="10%" height="20" class="borderBR"><div align="left" class="padl5">
							<input name="txtProdCode1" type="text" class="txtfield" id="txtProdCode1" style="width: 90%;" value=""/>
						...
						<td width="11%" height="20" class="borderBR"><div align="center"><input name="txtQty1" type="text" class="txtfield" id="txtQty1"  value="1" style="width: 90%; text-align:right" onBlur='addRow("dynamicTable");return false;'/></div></td>
			...
			<td>
				<div class="scroll_150">
					...
					<tr align="center">
						...
						<td width="8%" height="20" class="txtredbold borderBR"><div align="center" class="padl5">1</div></td>
						<td width="10%" height="20" class="borderBR"><div align="left" class="padl5">
							<input name="txtEProdCode1" type="text" class="txtfield" id="txtEProdCode1" style="width: 90%;" value=""/>
...
<tr>
	<td align="right">
		<input name='btnSave'   type='submit'  class='btn' value='Save'   onclick='return confirmSave();'> </form>          
	</td>	
        <td align="left">		
                <form name="frmCreateSingleLine" method="post" action="index.php?pageid=61">
