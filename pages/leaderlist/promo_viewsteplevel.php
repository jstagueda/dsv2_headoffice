...
<tr>
	<td>
		...
		<tr>
		    <td width="15%" height="20"><div align="right" class="txtpallete padl5"><strong>Promo Code / Description : </strong></div></td>
		    <td width="15%"  height="20"><div align="left">&nbsp;&nbsp;<input name="txtPromoCodeDesc" type="text" class="txtfield" id="txtPromoCodeDesc" value="<?php echo $scodedesc;?>" size="30"></div></td>
	    </tr>
		<tr>
		  	<td width="15%"  height="20"><div align="right" class="txtpallete padl5"><strong>Product Code: </strong></div></td>
		  	<td width="15%"  height="20"><div align="left">&nbsp;
