...
$(document).ready(function(){
	...
	$.ajax({
		...
		url: 'pages/leaderlist/leaderlist_call_ajax/ajax_promo_bridging.php',
...
{
	var objWin;
		popuppage = "pages/leaderlist/bridging_view.php?ID=" + objID
...
<tr>
	<td>
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1">
			<tr>
				<td width="70%">&nbsp;<a class="txtgreenbold13">Bridging Incentives Promo</a></td>	
			</tr>
		</table>
	</td>
</tr>
...
<?php endif; ?>
<br>
<form name="frmViewSetPromo" method="post" action="index.php?pageid=66&inc=2&startrow=0" style="min-height:520px;">
...
<tr>
	<td align="center">
		<input name='btnCreate' type='submit' class='btn' value='Create New' onclick="location.href='index.php?pageid=200'; return false;" /> 
	</td>			
</tr>
</table>
