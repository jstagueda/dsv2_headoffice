          ...
          if (xmlhttp.readyState==4 && xmlhttp.status==200)
            {
                ...
                else
                {
				  ...
				  document.getElementById('txtMinimum').removeAttribute("disabled"); 
				  document.getElementById('txtMaximum').removeAttribute("disabled"); 
				  document.getElementById('cboCriteria').removeAttribute("disabled"); 
				  document.getElementById('cboType').removeAttribute("disabled"); 
				  document.getElementById('txtTypeQty').removeAttribute("disabled"); 
				  document.getElementById('txtCriteria1').removeAttribute("disabled"); 
				  document.getElementById('txtCPMG1').removeAttribute("disabled"); 
		...
		<tr>
			<td width="50%">
				...
				<tr>
				    ...
				    <td height="20"><input name="txtCode" onblur = "CheckPromo();" type="text" class="txtfield" id="txtCode" value="<?php if (isset($_GET['promoID'])) { echo $promocode; } else { if (isset($_POST['txtCode'])) { echo $_POST['txtCode']; } } ?>" size="30" <?php if (isset($_GET['promoID'])) {?>readonly="yes"<?php } ?>></td>
			    </tr>
			    <tr>
				    <td height="20"><div align="left" class="padl5"><strong>Promo Description :</strong></div></td>
				    <td height="20"><input name="txtDescription" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> type="text" class="txtfield" id="txtDescription" value="<?php if (isset($_GET['promoID'])) { echo $promodesc; } else { if (isset($_POST['txtDescription'])) { echo $_POST['txtDescription']; } } ?>" style="width: 362px;" maxlength="60" <?php if (isset($_GET['promoID'])) {?>readonly="yes" <?php } ?>>
					</td>
			    </tr>
				<tr>
				  	<td height="20"><div align="left" class="padl5"><strong>Start Date: </strong></div></td>
				  	<td height="20">
						<input name="txtStartDate" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> type="text" class="txtfield" id="txtStartDate" size="20" readonly="yes" value="<?php if (isset($_POST['txtStartDate'])) { $tmpsdate = strtotime($_POST['txtStartDate']); $sdate = date("m/d/Y",$tmpsdate); echo $sdate; } else { echo $today; } ?>"  onChange="checkEndDate();">
				...
				<tr>
				  	...
				  	<td height="20">
						<input name="txtEndDate" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> type="text" class="txtfield" id="txtEndDate" size="20" readonly="yes" value="<?php if (isset($_POST['txtEndDate'])) { $tmpedate = strtotime($_POST['txtEndDate']); $edate = date("m/d/Y",$tmpedate); echo $edate; } else { echo $today; } ?>">
				...
				<tr>
				  	...
				  	<td height="20">
						<select name="cboPReqtType" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> class="txtfield" id="cboPReqtType" <?php if (isset($_GET['promoID'])) {?>disabled<?php } ?>>
			...
			<td width="50%" valign="top">
							...
							while($row = $rs_gsutype->fetch_object())
							{
								...
								if(isset($_GET['promoID'])){
									echo "<tr>
				    						...
				    						<td width='75%' height='20'><input type='text' class='txtfield' name='$txt' id = '$txt'></td>
				    				</tr>";
								}else{ 
									echo "<tr>
				    						<td width='15%' height='20'><div align='left' class='padl5'><strong>$row->Name :</strong></div></td>
				    						<td width='75%' height='20'><input type='text' class='txtfield' name='$txt' id = '$txt' disabled = 'true'></td>
				    				</tr>";
			    ...
			    <tr>
				    ...
				    <td height="20"><input type="checkbox" name="chkPlusPlan" id = "chkPlusPlan" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> value="1" <?php if(isset($_POST['chkPlusPlan'])) { echo "checked"; } ?>></td>
				</tr>
				</table>
			</td>
		</tr>
					...
					<td>
						...
						<tr>
							<td height="25" align="left" class="borderBR padl5">
								...
								&nbsp;
								<select name="cboCriteria" class="txtfield" id="cboCriteria" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> style="width: 80px;">
								...
								&nbsp;
								<input name="txtMinimum" id = "txtMinimum" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> type="text" value="" class="txtfield" style="width: 80px">
								&nbsp;&nbsp;
								<strong>Maximum Value :</strong>
								&nbsp;
								<input name="txtMaximum" id = "txtMaximum" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> type="text" value="" class="txtfield" style="width: 80px">
							</td>
						</tr>
						</table>
					</td>
						...
						<div class="scroll_150">
							...
							<tr align="center">
								...
								<td width="25%" height="20" class="borderBR"><div align="left" class="padl5">
									<input name="txtCriteria1" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> type="text" class="txtfield" id="txtCriteria1" style="width: 120px;" value="" />
								...
								<td width="20%" height="20" class="borderBR"><div align="left" class="padl5"><input name="txtCPMG1" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> type="text" class="txtfield" id="txtCPMG1" style="width: 100px;" value="" readonly="yes" /></div></td>			
							</tr>
							</table>
						</div>
					</td>
	...
	<td width="46%">
		...
		<tr align="center">
			<td height="25" class="borderBR"><div align="left" class="padl5">
				<strong>Type :</strong>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<select name="cboType" id = "cboType" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> class="txtfield" id="cboType" style="width: 100px;">
				...
				&nbsp;
				<input name="txtTypeQty" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> type="text" class="txtfield" id="txtTypeQty" style="width: 60px; text-align: right;">
			</div></td>
		</tr>
		<tr>
			<td valign="top" class="bgF9F8F7">
				...
				<div class="scroll_150">
					...
					<tr align="center">
						...
						<td width="12%" height="20" class="borderBR"><div align="left" class="padl5">
							<input name="txtEProdCode1" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> type="text" class="txtfield" id="txtEProdCode1" style="width: 75px;" value=""/>
						...
						<td width="15%" height="20" class="borderBR"><div align="center"><input name="txtEQty1" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> type="text" class="txtfield" id="txtEQty1"  value="1" style="width: 50px; text-align:right"  onkeypress="return disableEnterKey(event)"/></div></td>
						...
						<!--<input name="txtPmg1" type="text" id="txtPmg1" class="txtfield" readonly="readonly"  style="width: 138px; text-align:left" value=""/>-->
							<select name="cboEPMG1" class="txtfield" id="cboEPMG1" <?php if(isset($_GET['promoID'])){ }else{ echo 'disabled = "true"';} ?> style="width: 80px;">
								<?php
									if($rs_pmg->num_rows)
									{
