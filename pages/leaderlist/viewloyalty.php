...
$(document).ready(function(){
	...
	$.ajax({
		...
		url: 'pages/leaderlist/leaderlist_call_ajax/ajax_loyalty.php',
...
<tr>
	<td>
		...
		<tr>
			<td width="70%">&nbsp;<a class="txtgreenbold13">Loyalty Promos</a></td>
		</tr>
		</table>
	</td>
</tr>
...
?>
<br>
<form name="frmViewMultiLine" method="post" action="index.php?pageid=62" style="min-height: 523px;">
<div style="margin:auto; width:95%;">
    <table width="40%"  border="0" align="v" cellpadding="0" cellspacing="0">
<tr>
	<td class="tabmin"></td> 
...
<tr>
  ...
  <table width="100%"   border="0" cellpadding="0" cellspacing="0" id = "DynamicTable">
						...
						<tr><td colspan='5' height='30' class='borderBR'><div align='center'><span class='txtredsbold'>Fetching Data display.</span></div></td></tr>
...
<tr>
	<td align="center">
		...
		<input name='btnCreate' type='submit' class='btn' value='Create New' onclick="location.href='index.php?pageid=170.1'; return false;">	
	</td>			
</tr>
</table>
</form>
