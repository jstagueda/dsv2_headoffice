...
<script type="text/javascript" src="js/jxloyaltyproductlistuploader.js?rand=<?php echo $sessionUniqueID?>"></script>
				...
				<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
					  ...
					  <table width="95%"  border="0" align="left" cellpadding="0" cellspacing="0">
						  <tr>
							<td><span class="txtgreenbold13">Loyalty Program Product List Uploader</span></td>
							<td>&nbsp;</td>
						  </tr>
					   </table>
					  </td>
			...
			<!-- start of form ------------------------------------------------------------>															
												...
												<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordergreen" >
													...
													<tr>
													 ...
													 <tr>
													    <td height="20" class="bgF9F8F7" align="right">&nbsp;<div align="right" class="txt10">Loyalty Program:</div></td>
														<td height="20" class="bgF9F8F7"  >
															<select name="ReasonType" class="txtfield" id="reasontype" readonly>
															 <?PHP
																$reasonlist = SelectReason();
