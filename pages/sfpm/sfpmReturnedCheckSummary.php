...
<script type="text/javascript" src="js/jquery.ReturnedCheckSummary.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td valign="top" style="min-height: 610px; display: block;">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="topnav">&nbsp;&nbsp;<span class="txtgreenbold13">Returned Check Summary</span></td>
                </tr>
                <tr>
                    <td>
                        <div style="width:100%;">
                                         ...
                                         <table width="100%" border="0" align="left" cellpadding="0" cellspacing="3">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <input name="branchto" class ='txtfield' value="0" type="hidden">
                                                </td>
                                            </tr>
											<tr>
                                                <td width="30%" align="right"><strong>Sort By</strong></td>
                                                <td width="3%" align="center">:</td>
                                                <td align="left">
                                                    <select name="sortby" class="txtfield">
                                                        <option value="">SELECT</option>
                                                        <option value="b.Code">Branch</option>
                                                        <option value="igs.Code">IGS Code</option>
                                                        <option value="ibm.Code">IBM Code</option>
                                                        <option value="r.Code">Reason Code</option>
                                                    </select>
                                                </td>
                                            </tr>
											<tr>
                                                ...
                                                <div id="pgContent" >
                                                    <table width='100%' cellpadding='0' border=0 cellspacing='0' class="bordergreen">
                                                        <tr class="trheader">
                                                            ...
                                                            <td align='center'>DM Reference No.</td>
                                                            <td align='center'>DM Date</td>
                                                            <td align='center'>OR Number</td>
                                                            <td align='center'>OR Date</td>
                                                            <td align='center'>Check No.</td>
                                                            <td align='center'>IGS Code</td>
                                                            <td align='center'>IGS Name</td>
                                                            <td align='center'>IBM Code</td>
