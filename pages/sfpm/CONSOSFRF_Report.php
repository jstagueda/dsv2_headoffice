...
<script type="text/javascript" src="js/jxCONSOSFRF.js?rand=<?php echo $sessionUniqueID?>"></script>

<?php include IN_PATH.DS."scCONSOSFRF.php";?>
    ...
    <tr>
        <td valign="top">
            ...
            <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
                <tr>
                    <td class="txtgreenbold13">Loaded Computed SF/RF Report</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
            <br />
