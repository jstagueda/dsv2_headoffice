...
<script type="text/javascript" src="js/jxDealerSalesReport.js"></script>
    ...
    <tr>
        <td valign="top">
            ...
            <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
                <tr>
                    <td class="txtgreenbold13">Dealer Sales Report</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
            <br />
            ...
            <div style="width:95%; margin:0 auto;">
                <div style="float:left; width:610px;">
                    ...
                    <div class="tbl-head-content-center tbl-float-inherit" style="width: 600px;">
                        <span>Action</span>
                    </div>
                    <div class="tbl-head-content-right tbl-float-inherit"></div>
                    <div class="tbl-clear"></div>
                    <div class="formwrapper">
                        <form action="" method="post" name="formdealersales">
                        <table width="100%">
							<tr>
                            ...
                            <tr>
                                <td align="right">Dealer Range</td>
                                <td width="3%" align="center">:</td>
                                <td>
                                    <input name="dealerfrom" value="" class="txtfield">
                                    <input name="dealerfromHidden" value="0" type="hidden" class="txtfield">
                                    -
                                    <input name="dealerto" value="" class="txtfield">
                                    <input name="dealertoHidden" value="0" type="hidden" class="txtfield">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="3%" align="center">:</td>
                                <td>
                                    <input name="datefrom" value="<?=date("m/d/Y")?>" readonly="yes" class="txtfield">
                                    -
                                    <input name="dateto" value="<?=date("m/d/Y")?>" readonly="yes" class="txtfield">
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Minimum Accumulative PO</td>
                                <td width="3%" align="center">:</td>
                                <td>
                                    <input name="accumulativePO" value="0" class="txtfield">
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Amount(CSP/DGS/Invoice)</td>
                                <td width="3%" align="center">:</td>
                                <td>
                                    <input name="amount" value="0" class="txtfield">
                                </td>
                            </tr>
                            <tr>
