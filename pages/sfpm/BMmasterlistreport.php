...
<script type="text/javascript" src="js/jxBMmasterlistrpt.js?rand=<?php echo $sessionUniqueID?>"></script>

<?php include IN_PATH.DS."scBMmasterlist.php";?>
    ...
    <tr>
        <td valign="top">
            ...
            <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
                <tr>
                    <td class="txtgreenbold13">BM Consolidated Network Report</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
            <br />
                ...
                <div style="float:left; width:540px;">
                    ...
                    <div class="formwrapper">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td align="right">Include Other Account</td>
                                <td width="3%" align="center">:</td>
                                <td>
                                    <input type="radio" name="summarydetail" checked="yes" value="yes">YES
                                    <input type="radio" name="summarydetail" value="no">NO
                                </td>
                            </tr>
                            <tr>
                            ...
                            <td colspan="3">
                                <div class="pgLoading">
                                    <table style="border:1px solid #FF00A6; border-top:none;" class="tablelisttable" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr class="listtr">
                                            <td align="center" colspan="12">No result found.</td>
                                        </tr>
                                    </table>
                                </div>
                            </td>
