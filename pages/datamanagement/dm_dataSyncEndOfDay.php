...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td valign="top">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="topnav">&nbsp;&nbsp;<span class="txtgreenbold13">Data Management - End Of Day (Data Sync)</span></td>
                </tr>
                <tr>
                    <td>
                        <!-- FORM STARTS HERE -->
                        <div class="tbl-content-div">
                            ...
                            <div class="tbl-mid-content tbl-float-inherit" style="width: 354px;">
                                <form class="tbl-float-inherit" id="DM-syncForm" method="POST" action="">
                                    ...
                                    <input type="hidden" name="action" id="action" value="doEODAndBranchSync" />
                                    <input type="submit" value="Process EOD and Branch Sync to HO" id="btnSync" class="btn" name="btnSync">
                        ...
                        <div class="tbl-listing-div">
                            ...
                            <div class="tbl-mid-content tbl-float-inherit" style="width: 486px;">
                                ...
                                <iframe class="tbl-mid-logs tbl-float-inherit hide" id="syncframe-log-view" src="<?php echo $logPath; ?>/logs/syncEOD_process.log" frameborder="0"></iframe>
                            </div>
                        </div>
                        <div class="tbl-clear clear-small"></div>
                    </td>
