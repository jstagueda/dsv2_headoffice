...
<script type="text/javascript" src="js/jxnationaliddumping.js?rand=<?php echo $sessionUniqueID?>"></script>
				...
				<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
					  ...
					  <table width="95%"  border="0" align="left" cellpadding="0" cellspacing="0">
						  <tr>
							<td><span class="txtgreenbold13">National ID Dumping</span></td>
							<td>&nbsp;</td>
						  </tr>
					   </table>
					  </td>
								...
								<td width="100%" valign="top">
										 ...
										 <table width="60%"  border="0" align="left" cellpadding="0" cellspacing="0" >
												...
												<table width="100%"  border="0" cellpadding="0" cellspacing="0">
													...
													<tr>
														<td class="tabmin">&nbsp;</td>
														<td class="tabmin2"><span class="txtredbold">National ID Dumping</span>&nbsp;</td>
														<td class="tabmin3">&nbsp;</td>
													</tr>
												</table>
													...
													<tr>
													 ...
													 <tr>
													    ...
													    <td height="20" class="bgF9F8F7" align="Left" colspan = 3>&nbsp;
														  Facility to Dump National ID related changes
													    </td>
													</tr> 
