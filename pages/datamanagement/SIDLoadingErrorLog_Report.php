...
<script src="js/jxPagingSIDErrorLogReport.js?rand=<?php echo $sessionUniqueID?>" language="javascript" type="text/javascript"></script>
...
<tr>
    ...
    <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
        <tr>
            <td class="txtgreenbold13">SID Loading Error Log</td>
            <td>&nbsp;</td>
  	</tr>
    </table>
    <br />
    	...
    	<div style="width:95%; margin:0 auto;">
                <div style="float:left; width:550px;">
                    ...
                    <table width="100%"  border="0" style="border-top:none;" align="left" cellpadding="0" cellspacing="1" class="bordersolo">
						...
						<tr>
                            <td align="right"><strong>SID Type</strong></td>
                            <td align="center" height="20">:</td>
                            <td align="left">
                                <select name="sidtype" class="txtfield">
                                    <option value="">[SELECT]</option>
                                    <option value="BDS">Branch Daily Sales</option>
									<option value="ARE">Branch Daily Collection</option>
									<option value="DMCM">Branch Daily DMCM</option>
									<option value="INV">Branch Daily Inventory</option>
                                </select>
                            </td>
			            </tr>         
                        <tr>
                            <td align="right"><strong>Display Type</strong></td>
                            <td align="center" height="20">:</td>
                            <td align="left">
                                <select name="displaytype" class="txtfield">
                                    <option value="">[SELECT]</option>
                                    <option value="0">With Error</option>
									<option value="1">Without Error</option>
                                </select>
                            </td>
			            </tr>         
                        <tr>
