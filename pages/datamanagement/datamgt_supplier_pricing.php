...
<?php
	include IN_PATH.DS."scSupplierPricing.php";
?>
...
<tr>
	...
	<br />
  	...
  	<tr>
		<td valign="top">
  			...
  			<tr>
				<td class="txtgreenbold13">Supplier Pricing</td>
				<td>&nbsp;</td>
			</tr>
			</table>
			<?php
	...
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1">
  	<tr>
		<td valign="top">
	 		<form name="frmSupplierPricing" method="post" action="index.php?pageid=58">
			...
			<tr>
				...
				<td width="30%" height="30">
					<input name="txtSearch" type="text" class="txtfield" id="txtSearch" value="<?php echo $search;?>" size="30">
					<span class="padr5"><input name="btnSearch" type="submit" class="btn" value="Search" /></span>
				</td>
			</tr>
			</table>
	  		</form>
 	...
 	<table width="97%" border="0" align="center" cellpadding="0" cellspacing="1">
  	<tr>
  		...
  		<form name="frmPricing" method="post" action="includes/pcSupplierPricing.php">
		<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0"  class="bgF9F8F7 txtdarkgreenbold10 bordergreen">
		<tr class="tab">
			<td width="5%" height="20" class=""><div align="center"><input name="chkAll" type="checkbox" id="chkAll" value="1" onclick="checkAll(this.checked);" /></div></td>
					...
					while($rs_row = $rs_pricing->fetch_object())
						{
							...
							<td width='5%' height='20' ><div align='center'><input type='checkbox' name='chkSelect[]' onclick='UnCheck();' id='chkSelect' value='$prodiduomid' </div></td>
							...
							<td width='14%' height='20' ><div align='center' class='padr5'>
       ...
       ?>
        ...
        <tr>
      		<td align="center"><input name="btnSave" type="submit" class="btn" value="Save" onclick="return ConfirmSave();"></td>
      	</tr>
    	</table>
    	<? } ?>
		</form>
