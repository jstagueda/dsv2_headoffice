...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td valign="top">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="topnav">&nbsp;&nbsp;<span class="txtgreenbold13">Data Management - Data Sync</span></td>
                </tr>
                <tr>
                    <td>
                        <!-- FORM STARTS HERE -->
                        <div class="tbl-content-div">
                            ...
                            <div class="tbl-head-content-center tbl-float-inherit" style="width: 368px;"><span>Sync Actions</span></div>
                            ...
                            <div class="tbl-mid-content tbl-float-inherit" style="width: 354px;">
                                <form class="tbl-float-inherit" id="DM-syncForm" method="POST" action="">
                                    ...
                                    <div class="tbl-lbl tbl-float-inherit" style="width: 250px;">Sync Method Options :<span class="required-asterisk">*</span></div>
                                    ...
                                    <input type="submit" value="Start Head Office Sync" id="btnSync" class="btn" name="btnSync">
                        ...
                        <div class="tbl-listing-div">
                            <div class="tbl-head-content-left tbl-float-inherit"></div>
                            <div class="tbl-head-content-center tbl-float-inherit" style="width: 500px;"><span>Sync Process Logs</span></div>
                            <div class="tbl-head-content-right tbl-float-inherit"></div>
                            <div class="tbl-clear"></div>
                            ...
                            <div class="tbl-mid-content tbl-float-inherit" style="width: 486px;">
                                ...
                                <iframe class="tbl-mid-logs tbl-float-inherit hide" id="syncframe-log-view" src="logs/sync_process.log" frameborder="0"></iframe>
                            </div>
                        </div>
                        <div class="tbl-clear clear-small"></div>
                    </td>
