...
#global $database;
require_once(IN_PATH.DS.'pcProductLoyaltyUploader.php');	
...
<script type="text/javascript" src="js/jxnationalidgenerator.js?rand=<?php echo $sessionUniqueID?>"></script>
		...
		<td valign="top" style="min-height: 610px; display: block">
				...
				<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
					  ...
					  <table width="95%"  border="0" align="left" cellpadding="0" cellspacing="0">
						  <tr>
							<td><span class="txtgreenbold13">National ID Generator</span></td>
							<td>&nbsp;</td>
						  </tr>
					   </table>
					  </td>
								...
								<td width="100%" valign="top">
										 ...
										 <table width="60%"  border="0" align="left" cellpadding="0" cellspacing="0" >
												...
												<table width="100%"  border="0" cellpadding="0" cellspacing="0">
													...
													<tr>
														<td class="tabmin">&nbsp;</td>
														<td class="tabmin2"><span class="txtredbold">National ID Generator</span>&nbsp;</td>
														<td class="tabmin3">&nbsp;</td>
													</tr>
												</table>
			...
			<!-- start of form ------------------------------------------------------------>															
												...
												<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="bordergreen" >
													...
													<tr>
													  <td width="10%" height="20" class="bgF9F8F7">&nbsp;<span class="txtwhitebold">&nbsp;</span></td>
													  <td width="90%" height="20" class="bgF9F8F7">&nbsp;</td>
													</tr>
												
													 <tr>
													    
													    <td height="20" class="bgF9F8F7" align="Center" colspan = 4 style = "font-weight: bold; font-size: 85%; ">
														  Facility to load BM List dump files @ DSv2 Head Office
													    </td>
													</tr> 
													<tr>
													  <td width="10%" height="20" class="bgF9F8F7">&nbsp;<span class="txtwhitebold">&nbsp;</span></td>
