...
<script type="text/javascript" src="js/jxcomputedsfrfuploader.js?rand=<?php echo $sessionUniqueID?>"></script>
				...
				<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
					  ...
					  <table width="95%"  border="0" align="left" cellpadding="0" cellspacing="0">
						  <tr>
							<td><span class="txtgreenbold13">Automated loading of computed SF/RF </span></td>
							<td>&nbsp;</td>
						  </tr>
					   </table>
					  </td>
