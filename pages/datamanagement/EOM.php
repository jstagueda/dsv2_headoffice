...
<script type="text/javascript">
	...
	{	
		...
		url="includes/scEOM.php?month=" +test.value;
		lyrName='divTest';
        ...
        <tr>
		   <td valign="top">
			  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1">
				 <tr>
					<td class="txtgreenbold13">End of Month</td>
					<td>&nbsp;</td>
				 </tr>
				 <tr>
						...
						<form name="frmEOD" method="post" action="index.php?pageid=54">
							<td><table width="99%"  border="0" align="center" cellpadding="0" cellspacing="1">
								...
								<td align="right"><select name="cboMonth" id="cboMonth" class="txtfield">
								  ...
								  ?>
								  <td align="left" >
									 &nbsp;&nbsp;&nbsp;<input name="btnSync" type="button" class="btn" value="Start End of Month Transactions" onClick="startEOD()" >                              
								  </td>
								</tr>
								<tr>
								  <td>&nbsp;</td>
