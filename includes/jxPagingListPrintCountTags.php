...
$query = $sp->spSelectRecordtInvCntCount($database, $vSearch);
...
*/
		...
		$query = $sp->spSelectRecordUnconfirmedInvCount($database, $offset, $RPP, $vSearch);
		$num=$query->num_rows;
		...
		while($row = $query->fetch_object()) {
		  ...
		  echo "<tr align='center' class='$alt'>
					  ...
					  <a href='index.php?pageid=134.1&tid=$id' class='txtnavgreenlink'>$txnno</a></td>
