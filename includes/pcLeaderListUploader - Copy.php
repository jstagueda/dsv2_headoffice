					...
					foreach ($rows as $row)
				 	{
						...
						else if ($uType == 7) //multiline promo - entitlement
						{
                            ...
                            $mb_entproddesc = trim(stripslashes(str_replace("'", "\'",$rdata[1])));
                                                        $mb_entproddesc = trim(stripslashes(str_replace("|", ";",$rdata[7])));
                                                        $mb_entproddesc = trim(stripslashes(str_replace(array("\r","\n"),"|",$rdata[7])));
                                                        $mb_entproddesc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$rdata[7])));
