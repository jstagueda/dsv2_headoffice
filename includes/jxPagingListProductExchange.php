...
$query = $sp->spSelectProductExchangeCount($database, $vSearch, $fromDate, $toDate);
...
*/
		...
		while($row = $query->fetch_object()) {
				...
				echo "<tr align='center' class='$alt'>
						  ...
						  <a href='index.php?pageid=160.1&TxnID=$id&TxnInvoice=$SalesInvoiceID&msg=' class='txtnavgreenlink'>$sono</a></td>
	...
	echo "<tr align='center' colspan = '17'>
