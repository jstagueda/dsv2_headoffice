...
$query = $sp->spSelectProductCount($database, $vSearch);
...
if ($num2>0)
{
	...
	elseif ($maxPage>=1 AND $type=='con')
	{
		echo "<table width='100%'  border='0' align='center' cellpadding='0' cellspacing='0'>
				<tr><td class='tab' style='border-bottom:2px solid #FFA3E0;'>";
		echo "<table width='100%'  border='0' align='center' cellpadding='0' cellspacing='0' height='100%'>
				<tr>
      				<td width='30%' align='center' class='bdiv_r padl5' style='background:#FFDEF0;'><span class='txtredbold'>Code</span></td>
          			<td width='50%' align='center' class='bdiv_r padl5' style='background:#FFDEF0;'><span class='txtredbold'>Description</span></td>
          			<td width='20%' style='background:#FFDEF0;'><div align='center'><span class='txtredbold'>No. of Subs</span></div></td>
				</tr></table></td></tr>";
		echo "<tr><td><table width='100%'  border='0' align='center' cellpadding='0' cellspacing='0'>";

		//Get all the rows
		$query = $sp->spSelectListProductSubstitute($database,$offset, $RPP , $vSearch);
		$num = $query->num_rows;
                 ...
                 while($row = $query->fetch_object())
                  {
                    $rowalt++;
                      ...
                      echo  "<tr align='center' class='$class'>
								<td height='20' class='borderBR padl5' width='30%' align='center'><span class='txt10'>
									<a href='index.php?pageid=111&prodid=$row->pid&subs=1&svalue=$vSearch' class='txtnavgreenlink' style='color:blue;'>$row->code</a>
								</td>
								<td height='20' class='borderBR padl5' width='50%' align='left'><span class='txt10'>$row->description</span></td>
								<td height='20' class='borderBR' width='20%' align='center'><span class='txt10'>$row->noSubs</span></td>
							</tr>";
                    }
            }else{
				echo "<tr align='center' class='$class'>
						<td align='center' colspan='3' style='padding:5px;'>No result found.</td>
					</tr>";
			}
		//Close table
...
else if (($num2 <= 0) && ($type == 'con'))
{
	echo "<table width='100%'  border='0' align='center' cellpadding='0' cellspacing='0'>
					<tr class='tab' style='border-bottom:2px solid #FFA3E0;'>
                      			<td width='20%' class='bdiv_r' style='background:#FFDEF0;'><div align='center'>&nbsp;<span class='txtredbold'>Code</span></div></td>
                      			<td width='50%' class='bdiv_r' style='background:#FFDEF0;'><div align='center'><span class='txtredbold'>Description</span></div></td>
                      			<td width='15%' style='background:#FFDEF0;'><div align='center'><span class='txtredbold'>No. of Subs</span></div></td>
	              			</tr>
	    <tr><td colspan='3' height='20' class='borderBR'><div align='center'><span class='txtredsbold'>No record(s) to display.</span></div></tr>
	    </table>";
}
