<?php
    ...
    function sidlist($database, $datefrom, $dateto, $displaytype,$istotal, $page, $total, $branch,$sidtype)
	{
		...
		$query = $database->execute("
		                              SELECT  DATE(so_header.ORDER_DATE), so_header.doc_type , so_header.ADDR_NO , b.Code,  b.Name , so_header.DOC_NO_ORI, sf.Filename, 
											(
									 ...
									 $daterange
									 AND so_header.doc_type = '$displaytype'
		                           ");
		return $query; 						   
	}
