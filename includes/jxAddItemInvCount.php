	...
	if(len)
	{
		...
		for(i=0; i<=len ; i++ )
		{
			...
			if(prodList[i].checked == true)
			{
				...
				var hasSubstitute	= 'hHasSubstitute'+i;
				...
				{
					SOH.setAttribute('onclick', 'substituteItem('+subsprodID+','+index+')');
...
<?php
	...
	echo'<tr height="22">
			...
			;
	$rsGetProductList = $sp->spSelectProductSubstituteSO($database,$prodID);
	$cnt =0;
