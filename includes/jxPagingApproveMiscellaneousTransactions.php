...
$query = $sp->spSelectApproveAdjustmentCount($database, $vSearch);
...
*/
		echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1' class='tab'>
                    <tr align='center'>
                      <td width='15%' height='20' class='bdiv_r'><b>Transaction Number </b></td>
                      <td width='15%' height='20' class='bdiv_r'><b>Document Number</b></td>
					  <td width='15%' height='20' class='bdiv_r'><b>Transaction Date</b></td>
					  <td width='15%' height='20' class='bdiv_r'><b>Branch</b></td>
                      <td width='20%' height='20' class='bdiv_r'><b>Warehouse</b></td>
                      <td width='20%' height='20'><b>Status</b></td>
                    </tr>";
		
		
		//Get all the rows
		
		$query = $sp->spSelectApproveAdjustment($database, $offset, $RPP, $vSearch);
		$num=$query->num_rows;
		...
		while($row = $query->fetch_object()) 
		{
		  ...
		  echo "<tr align='center' class='$alt'>
					  <td width='15%' height='20' class='borderBR'><a href='index.php?pageid=119.1&tid=$id' class='txtnavgreenlink'>$txnno</a></td>
					  <td width='15%' height='20' class='borderBR'>$docno</td>
					  <td width='15%' height='20' class='borderBR'>$txndate</td>
					  <td width='15%' height='20' class='borderBR'>$branch</td>
					  <td width='20%' height='20' class='borderBR'>$warehouse</td>
					  <td width='20%' height='20' class='borderBR'>$status</td>
				  </tr>";
		  }
