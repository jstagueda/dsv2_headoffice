...
$query = $sp->spSelectPromoCount($database, 0, $RPP, 3,  $scodedesc, $sprodcode, $isinc);
	...
	elseif ($maxPage>=1 AND $type=='con') 
	{
		echo "<table width='100%'  border='0' cellpadding='0' cellspacing='0'>
				<tr align='center' class='txtdarkgreenbold10'>
					<td width='4%' class='txtpallete bdiv_r'><div align='left' class='padl5'>Promo Code</div></td>
					<td width='15%' height='20' class='txtpallete bdiv_r'><div align='left' class='padl5'>Promo Description</div></td>			
		...
		//Get all the rows
		$query = $sp->spSelectPromo2($database, $offset, $RPP, 3,  $scodedesc, $sprodcode, $isinc);
		$num = $query->num_rows;
		...
		while($row = $query->fetch_object()) 
		{
		  ...
		  echo "<tr align='center' class='trlist'>
                      ...
                      <div align='left' class='padl5'><a href='javascript:void(0)' onclick='return openPopUp($prmSID, $isinc);' class='txtnavgreenlink'>$row->Code</a></div></td>
...
{
	echo "<table width='100%'  border='0' cellpadding='0' cellspacing='0' class='txtdarkgreenbold10'>
		<tr align='center'>
			<td width='4%'  height='20' class='txtpallete bdiv_r'><div align='left' class='padl5'>Promo Code</div></td>
			<td width='15%' height='20' class='txtpallete bdiv_r'><div align='left' class='padl5'>Promo Description</div></td>			
			<td width='10%' height='20' class='txtpallete bdiv_r'><div align='center' class='padr5'>Start Date</div></td>
			<td width='10%' height='20' class='txtpallete bdiv_r'><div align='center' class='padr5'>End Date</div></td>
			<td width='10%' height='20'><div align='center' class='txtpallete padr5'>Date Created</div></td>
		</tr>
