...
$query = $sp->spSelectORCount($database, $vSearch, $fromDate, $toDate);
...
*/
		...
		//Get all the rows
		$query = $sp->spSelectOfficialReceipt($database, $offset, $RPP, $vSearch, $fromDate, $toDate);	
		...
		while($row = $query->fetch_object()) {
		  ...
		  echo "<tr align='center' class='$alt'>
					  ...
					  <a href='index.php?pageid=96.1&TxnID=$id' class='txtnavgreenlink'>$orno</a></td>
