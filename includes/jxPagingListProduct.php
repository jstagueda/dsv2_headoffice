...
if ($num>0)
{
	...
	{
		echo "<table width='100%'  border='0' valign='center' cellpadding='0' cellspacing='0' class='tab bordergreen_T' style='border-top:none;'>
					<tr height='22'  valign='center' style='background:#FFDEF0;'>
                         <td width='30%'><div align='left'>&nbsp;<span class='padl5 txtpallete'>Item Code</span></div></td>
                         <td width='75%'><div align='left'><span class='padl5 txtpallete'>Item Name</span></div></td>
                    </tr>";
                 ...
                 while($row = $query->fetch_object())
                  {
                    $rowalt++;
                      ...
                      echo "<tr align='center' class='$class'>
								<td height='21' class='borderBR' width='30%' align='center'>
									<span class='txt10'>
										<a href='index.php?pageid=20&pID=$row->ProductID&searchedTxt=$vSearch' class='txtnavgreenlink' style='color:blue;'>
											$row->ProductCode
										</a>
									</span>
								</td>
								<td class='borderBR' width='75%' align='left' style='padding:3px;'>
									<span class='txt10'>
										$row->ProductName
									</span>
								</td>
