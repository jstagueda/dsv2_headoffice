...
$query = $sp->spSelectAdjustmentCount($vSearch);
...
*/
		...
		$query = $sp->spSelectAdjustment($offset, $RPP, $vSearch);
		$num=$query->num_rows;
		...
		while($row = $query->fetch_object()) {
		 ...
		 /* echo "<tr align='center' class='$alt'>
					  ...
					  <a href='index.php?pageid=3.1&tid=$id' class='txtnavgreenlink'>$id</a></td>
					  <td width='20%' class='borderBR'> $docno </td>
					  <td width='20%'  class='borderBR'> $trandate </td>
