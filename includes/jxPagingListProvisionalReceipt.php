...
$query = $sp->spSelectPRCount($database, $vSearch, $fromDate, $toDate);
...
*/
		echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1' class='tab'>
                    <tr align='center'>                     
                      <td width='15%' class='bdiv_r'><b>PR Number</b></td>
					   <td width='15%' class='bdiv_r'><b>Document Number</b></td>
					  <td width='20%' class='bdiv_r'><b>Customer Name</b></td>
					  <td width='15%' class='bdiv_r' height='20'><b>PR Date</b></td>                      					  
                      <td width='15%' ><b>Status</b></td>
                    </tr>";
		//Get all the rows
	/*	$query = $sp->spSelectProvisionalReceipt($offset, $RPP, $vSearch,$fromDate,$toDate);	*/
	
			$query = $sp->spSelectProvisionalReceipt($database, $offset, $RPP, $vSearch, $fromDate, $toDate);	
		...
		while($row = $query->fetch_object()) {
		  ...
		  echo "<tr align='center' class='$alt'>
					  ...
					  <a href='index.php?pageid=51.1&TxnID=$id' class='txtnavgreenlink'>$orno</a></td>
					  <td  class='borderBR'> $ordocno </td>					  
