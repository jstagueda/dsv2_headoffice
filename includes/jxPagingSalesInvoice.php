<?php
	...
	*/
	...
	$query = $sp->spSelectSalesInvoiceCount($database, $vSearch);
	...
	*/
			echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1' class='tab'>
	                    <tr align='center'>
	                      	<td width='9%' height='20' class='bdiv_r'><b>SI Number </td>
                        	<td width='13%' class='bdiv_r'><b>Document Number</b></td>
	                        <td width='11%' class='bdiv_r'><b>SO Number</b></td>
	                        <td width='20%' class='bdiv_r'><b>Customer Name</b></td>
	                        <td width='8%' class='bdiv_r'><b>SI Date</b></td>
	                        <td width='7%'><b>Status</b></td>
	                    </tr>";
			//Get all the rows
			
			$query = $sp->spSelectSalesInvoice($database, $offset, $RPP, $vSearch);
			$num = $query->num_rows;
			...
			{				 
			  ...
			  echo "<tr align='center' class='$alt'>						  
						<td width='9%' height='20' class='borderBR'><a href='index.php?pageid=40.1&tid=$id' class='txtnavgreenlink'>$txnno</a></td>
                        <td width='13%' class='borderBR'>$docno</td>                        
	                    <td width='11%' class='borderBR'>$sono</td>	                    
	                    <td width='20%' class='borderBR'>$customer</td>
	                    <td width='8%' class='borderBR'>$txndate</td>
	                    <td width='7%' class='borderBR' class='borderBR' class='borderBR'>$status</td>
					</tr>";
			  }
