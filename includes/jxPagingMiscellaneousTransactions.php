...
$query = $sp->spSelectAdjustmentCount($database, $vSearch);
...
*/
		...
		$query = $sp->spSelectAdjustment($database, $offset, $RPP, $vSearch);
		$num=$query->num_rows;
...
//				$class = $row->classname;
		  ...
		  echo "<tr align='center' class='$alt'>
					  ...
					  <a href='index.php?pageid=3.1&tid=$id' class='txtnavgreenlink'>$row->TransNo</a></td>
