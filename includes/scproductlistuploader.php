...
$database->execute(" truncate tmployalty_program_productlist");

}

function view_reservation($ResNo,$Limit)
{
   global $database; 
   
   $reserveditems = $database->execute(" 
											SELECT
												rd.ReservationNo resnumber,
												rd.ProductCode resproductcode,
												(SELECT NAME FROM product WHERE CODE=rd.productcode) description,
												rd.ApprovedQuantity resquantity,
											...
											INNER JOIN 
												reservationdetails rd ON res.ReservationNo=rd.ReservationNo
												
											WHERE 
												res.ReservationNo='$ResNo'
...
///////////////////////////////////////////////////////////
function view_reservation_total($ResNo)
{
   global $database; 
