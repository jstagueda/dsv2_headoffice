...
$query = $sp->spSelectInventoryInRHOCount($database, $vSearch);
	...
	elseif ($maxPage>=1 AND $type=='con') 
	{
		echo "<table width='100%'  border='0' cellpadding='0' cellspacing='0' >
                    <tr align='center' class='tab'>
                      ...
                      <td width='10%' class='borderBR'><b>DR Date</b></td>
                      ...
                      <td width='10%' class='borderBR'><b>Cofirmation Date</b></td>
                      <td width='20%' class='borderBR'><b>Confirmed By</b></td>
                    </tr>";
                    
		//Get all the rows
		
		$query = $sp->spSelectInventoryInRHO($database, $offset, $RPP, $vSearch);
		$num = $query->num_rows;
		...
		while($row = $query->fetch_object()) 
		{
		  ...
		  echo "<tr align='center' class='$alt'>
					<td height='20' class='borderBR'>$txnNo</td>
					<td height='20' class='borderBR'><a href='index.php?pageid=26.1&tid=$id' class='txtnavgreenlink'>$row->DocumentNo.$row->ToBranchCode</a></td>
					...
					<td height='20' class='borderBR'>$confirmedDate</td>
