...
$query = $sp->spSelectDRCount($database, $vSearch);
...
*/
		echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1' class='tab'>
                    <tr align='center'>
                      <td width='15%' class='bdiv_r'><b>DR Number </b></td>
                      <td width='15%' class='bdiv_r'><b>SO Number</b></td>
					  <td width='20%' class='bdiv_r'><b>Customer Name</b></td>
					  <td width='15%' class='bdiv_r' height='20'><b>Delivery Date</b></td>                      					  
                      <td width='15%' ><b>Status</b></td>
                    </tr>";
		//Get all the rows
		$query = $sp->spSelectDR($database, $offset, $RPP, $vSearch);		
		$num=$query->num_rows;
		...
		while($row = $query->fetch_object()) {
		  ...
		  echo "<tr align='center' class='$alt'>
					  ...
					  <a href='index.php?pageid=45.1&TxnID=$id&SOID=$reftxnid' class='txtnavgreenlink'>$drdocno</a></td>
