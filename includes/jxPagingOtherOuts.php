...
$query = $sp->spSelectInventoryOutCount($database, $vSearch);
...
*/
		echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1' class='tab'>
                    <tr align='center'>
                      ...
                      <td width='17%' class='bdiv_r'><b>Inventory Out Type</b></td>
                      <td ><b>Status</b></td>
                    </tr>";
		//Get all the rows
		
		$query = $sp->spSelectInventoryOut($database, $offset, $RPP, $vSearch);
		$num=$query->num_rows;
