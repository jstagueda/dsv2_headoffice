					...
					foreach ($rows as $row)
				 	{
					  	...
					  	if ($uType == 5) //single line promo
						{
							$promocode = str_replace("'", "\'",$rdata[0]);
                                                        ...
                                                        $promodesc = trim(stripslashes(str_replace("'", "\'",$rdata[1])));
                                                        $promodesc = trim(stripslashes(str_replace("|", ";",$rdata[1])));
                                                        $promodesc = trim(stripslashes(str_replace(array("\r","\n"),"|",$rdata[1])));
                                                        $promodesc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$rdata[1])));
														$promodesc = trim(stripslashes(str_replace(array("&", ":"), array('&', ':'), $rdata[1])));														
                                                        $promodesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $rdata[1])));
														$promodesc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $rdata[1])));
														$promodesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $rdata[1])));														
							...
							$buyinpdesc = str_replace("'", "\'",$rdata[9]);
														...
														$buyinpdesc = trim(stripslashes(str_replace(array("&", ":"), array('&', ':'), $rdata[9])));	
                                                        $buyinpdesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $rdata[9])));
														$buyinpdesc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $rdata[9])));
														$buyinpdesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $rdata[9])));
							...
							$entprodcode = str_replace("'", "\'",$rdata[14]);
														...
														$entproddesc = trim(stripslashes(str_replace(array("&", ":"), array('&', ':'), $rdata[15])));															
														$entproddesc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $rdata[15])));
														$entproddesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $rdata[15])));
                                                        $entproddesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $rdata[15])));
							...
							if($promocode!=NULL){							
								...
								$promocode, 
								mysql_real_escape_string($promodesc), 
								$promosdate, 
								$promoedate, 
								$buyintype, 
								$buyinminqty, 
								...
								$buyinplevel, 
								$buyinpcode, 
								mysql_real_escape_string($buyinpdesc),
								$buyinreqtype, 
								$buyinleveltype, 
								$enttype, 
								$entqty, 
								$entprodcode, 
								mysql_real_escape_string($entproddesc), 
								$entdetqty, 
								mysql_real_escape_string($entdetprice),
						...
						else if ($uType == 6) //multiline promo - buyin
						{
                           ...
                           $mb_promodesc = trim(stripslashes(str_replace("'", "\'",$rdata[1])));
                                                        $mb_promodesc = trim(stripslashes(str_replace("|", ";",$rdata[1])));
                                                        $mb_promodesc = trim(stripslashes(str_replace(array("\r","\n"),"|",$rdata[1])));
                                                        $mb_promodesc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$rdata[1])));
														$mb_promodesc = trim(stripslashes(str_replace(array("&", ":"), array('&', ':'), $rdata[1])));														
                                                        $mb_promodesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $rdata[1])));
														$mb_promodesc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $rdata[1])));
														$mb_promodesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $rdata[1])));		
                           ...
                           $mb_buyinpdesc = trim(stripslashes(str_replace("'", "\'",$rdata[9])));
                                                        $mb_buyinpdesc = trim(stripslashes(str_replace("|", ";",$rdata[9])));
                                                        $mb_buyinpdesc = trim(stripslashes(str_replace(array("\r","\n"),"|",$rdata[9])));
                                                        $mb_buyinpdesc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$rdata[9])));
														$mb_buyinpdesc = trim(stripslashes(str_replace(array("&", ":"), array('&', ':'), $rdata[9])));															
                                                        $mb_buyinpdesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $rdata[9])));
														$mb_buyinpdesc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $rdata[9])));
														$mb_buyinpdesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $rdata[9])));															
							...
							$Uploader_rows = $sp->spInsertTmpMultiLineBuyinPromo($database, 
																	$mb_promocode, 
																	mysql_real_escape_string($mb_promodesc), 
																	$mb_promosdate, 
																	$mb_promoedate, 
																	$mb_buyintype, 
																	$mb_buyinminqty, 
																	...
																	$mb_buyinplevel, 
																	$mb_buyinpcode, 
																	mysql_real_escape_string($mb_buyinpdesc), 
																	$mb_buyinreqtype, 
																	$mb_buyinleveltype, 
																	$ml_isplusplan);
																}
						...
						else if ($uType == 7) //multiline promo - entitlement
						{
							...
							$mb_entproddesc = $rdata[7];
							$mb_entproddesc = str_replace("'", "'",$rdata[7]);
							$mb_entproddesc = str_replace("'", "\'",$rdata[7]);
							$mb_entproddesc = str_replace("*", "/'", ",",$rdata[7]);													  
							$mb_entproddesc = str_replace(array("\r","\n")," ",$rdata[7]);
							$mb_entproddesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $rdata[7])));	
							...
							$mb_entdetsavings = trim(stripslashes(str_replace(array(",", "."), array(',','.'), $rdata[10])));
							...
							if($mb_promocode!=NULL){	
							$Uploader_rows = $sp->spInsertTmpMultiLineEntitlementPromo($database, 
															$mb_promocode, 
															mysql_real_escape_string($mb_promodesc), 
															$mb_promosdate, 
															$mb_promoedate, 
															...
															$mb_entqty, 
															$mb_entprodcode, 
															mysql_real_escape_string($mb_entproddesc), 
															$mb_entdetqty, 
															$mb_entdetprice, 
															mysql_real_escape_string($mb_entdetsavings), 
															$mb_entdetpmg);
													}
						}
						else if ($uType == 8) //overlay promo - buyin
						{
							...
							$ol_isplusplan = str_replace(array(" ","null")," ",$rdata[18]);							
							
							
							if($ob_promocode!=NULL){	
								$Uploader_rows = $sp->spInsertTmpOverlayBuyinPromo($database, 
								$ob_promocode, 
								mysql_real_escape_string($ob_promodesc), 
								$ob_promosdate, 
								$ob_promoedate, 
								$ob_nongsu, 
								$ob_dirgsu, 
								...
								$ob_buyinplevel, 
								$ob_buyinpcode, 
								mysql_real_escape_string($ob_buyinpdesc), 
								$ob_buyincriteria, 
								$ob_buyinminval, 
								$ob_buyinsdate, 
								$ob_buyinedate, 
						...
						else if ($uType == 9) //overlay promo - entitlement
						{
							...
							$oe_promodesc = trim(stripslashes(str_replace("'", "\'",$rdata[1])));
							$oe_promodesc = trim(stripslashes(str_replace("|", ";",$rdata[1])));
							$oe_promodesc = trim(stripslashes(str_replace(array("\r","\n"),"|",$rdata[1])));
							$oe_promodesc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$rdata[1])));   
							$oe_promodesc = trim(stripslashes(str_replace(array("&", ":"), array('&', ':'), $rdata[1])));
							$oe_promodesc = trim(stripslashes(str_replace(array("(", ",", ")", ":","/"), array("(", ",", ")", ":","/"), $rdata[7])));								
							$oe_promodesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $rdata[1])));
							$oe_promodesc = trim(stripslashes(str_replace(array("'", "*", "'", "#", "/"), array('', '*',' ','#', "/"), $rdata[1])));
							
							$oe_promosdate = date('Y-m-d',strtotime(str_replace("'", "\'",$rdata[2])));
							$oe_promosdate = str_replace("|", ";",$rdata[2]);
							$oe_promosdate = str_replace(array("\r","\n"),"|",$rdata[2]);
							$oe_promosdate = str_replace(array("||||","|||","||"),"|",$rdata[2]);	
							
							$oe_promoedate = date('Y-m-d',strtotime(str_replace("'", "\'",$rdata[3])));
							$oe_promoedate = str_replace("|", ";",$rdata[3]);
							$oe_promoedate = str_replace(array("\r","\n"),"|",$rdata[3]);
							$oe_promoedate = str_replace(array("||||","|||","||"),"|",$rdata[3]);							
							...
							$oe_entproddesc = trim(stripslashes(str_replace("'", "\'",$rdata[7])));
							$oe_entproddesc = trim(stripslashes(str_replace("|", ";",$rdata[7])));
							$oe_entproddesc = trim(stripslashes(str_replace(array("\r","\n"),"|",$rdata[7])));
							$oe_entproddesc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$rdata[7])));   
							$oe_entproddesc = trim(stripslashes(str_replace(array("&", ":"), array('&', ':'), $rdata[7])));								
							$oe_entproddesc = trim(stripslashes(str_replace(array("(", ",", ")", ":","/"), array("(", ",", ")", ":","/"), $rdata[7])));								
							$oe_entproddesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $rdata[7])));
							$oe_entproddesc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $rdata[7])));
							$oe_entproddesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $rdata[7])));
							...
							$Uploader_rows = $sp->spInsertTmpOverlayEntitlementPromo(
													$database, 
													$oe_promocode, 
													mysql_real_escape_string($oe_promodesc), 
													$oe_promosdate, 
													$oe_promoedate, 
													$oe_enttype, 
													$oe_entqty, 
													$oe_entprodcode, 
													mysql_real_escape_string($oe_entproddesc), 
													$oe_entdetqty, 
													$oe_entdetprice, 
													$oe_entdetsavings, 
													$oe_entdetpmg);
					...
					if ($uType == 5)
					{
						...
						if ($singleline->num_rows)
						{
							while ($row = $singleline->fetch_object())
							{
								...
								$promo_code = str_replace(array("||||","|||","||"),"|",$row->PromoCode);	

								$promo_desc = str_replace("'", "\'",$row->PromoDescription);
								$promo_desc = trim(stripslashes(str_replace("'", "\'",$row->PromoDescription)));
								$promo_desc = trim(stripslashes(str_replace("|", ";",$row->PromoDescription)));
								$promo_desc = trim(stripslashes(str_replace(array("\r","\n"),"|",$row->PromoDescription)));
								$promo_desc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$row->PromoDescription)));    
								$promo_desc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $row->PromoDescription)));
								$promo_desc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $row->PromoDescription)));
								$promo_desc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $row->PromoDescription)));	
								...
								$promo_edate = str_replace(array("||||","|||","||"),"|",$row->PromoEndDate);
								
								$buyin_type = $row->BuyinTypeID;
								$buyin_type = str_replace("'", "\'",$row->BuyinTypeID);
								$buyin_type = str_replace("|", ";",$row->BuyinTypeID);
								$buyin_type = str_replace(array("\r","\n"),"|",$row->BuyinTypeID);
								$buyin_type = str_replace(array("||||","|||","||"),"|",$row->BuyinTypeID);
								
								$buyin_minqty = $row->BuyinMinQty;
								$buyin_minqty = str_replace("'", "\'",$row->BuyinMinQty);
								$buyin_minqty = str_replace("|", ";",$row->BuyinMinQty);
								$buyin_minqty = str_replace(array("\r","\n"),"|",$row->BuyinMinQty);
								$buyin_minqty = str_replace(array("||||","|||","||"),"|",$row->BuyinMinQty);	
								
								$buyin_minamt = $row->BuyinMinAmt;
								$buyin_minamt = str_replace("'", "\'",$row->BuyinMinAmt);
								$buyin_minamt = str_replace("|", ";",$row->BuyinMinAmt);
								$buyin_minamt = str_replace(array("\r","\n"),"|",$row->BuyinMinAmt);
								$buyin_minamt = str_replace(array("||||","|||","||"),"|",$row->BuyinMinAmt);	
								
								$buyin_plevel = $row->BuyinProductLevelID;
								$buyin_plevel = str_replace("'", "\'",$row->BuyinProductLevelID);
								$buyin_plevel = str_replace("|", ";",$row->BuyinProductLevelID);
								$buyin_plevel = str_replace(array("\r","\n"),"|",$row->BuyinProductLevelID);
								$buyin_plevel = str_replace(array("||||","|||","||"),"|",$row->BuyinProductLevelID);									
								
								$buyin_pcode = str_replace("'", "\'",$row->BuyinProductCode);
								$buyin_pcode = str_replace("'", "\'",$row->BuyinProductCode);
								$buyin_pcode = str_replace("|", ";",$row->BuyinProductCode);
								$buyin_pcode = str_replace(array("\r","\n"),"|",$row->BuyinProductCode);
								$buyin_pcode = str_replace(array("||||","|||","||"),"|",$row->BuyinProductCode);
								
								$buyin_pdesc = str_replace("'", "\'",$row->BuyinProductDescription);
								$buyin_pdesc = trim(stripslashes(str_replace("'", "\'",$row->BuyinProductDescription)));
								$buyin_pdesc = trim(stripslashes(str_replace("|", ";",$row->BuyinProductDescription)));
								$buyin_pdesc = trim(stripslashes(str_replace(array("\r","\n"),"|",$row->BuyinProductDescription)));
								$buyin_pdesc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$row->BuyinProductDescription)));    
								$buyin_pdesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $row->BuyinProductDescription)));
								$buyin_pdesc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $row->BuyinProductDescription)));
								$buyin_pdesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $row->BuyinProductDescription)));			
								...
								$buyin_leveltype = str_replace("'", "\'",$row->BuyinLevelTypeID);
								$buyin_leveltype = str_replace("|", ";",$row->BuyinLevelTypeID);
								$buyin_leveltype = str_replace(array("\r","\n"),"|",$row->BuyinLevelTypeID);
								$buyin_leveltype = str_replace(array("||||","|||","||"),"|",$row->BuyinLevelTypeID);	
								
								$ent_type = $row->EntitlementTypeID;
								$ent_type = str_replace("'", "\'",$row->EntitlementTypeID);
								$ent_type = str_replace("|", ";",$row->EntitlementTypeID);
								$ent_type = str_replace(array("\r","\n"),"|",$row->EntitlementTypeID);
								$ent_type = str_replace(array("||||","|||","||"),"|",$row->EntitlementTypeID);	
								
								$ent_qty = $row->EntitlementQty;
								$ent_qty = str_replace("'", "\'",$row->EntitlementQty);
								$ent_qty = str_replace("|", ";",$row->EntitlementQty);
								$ent_qty = str_replace(array("\r","\n"),"|",$row->EntitlementQty);
								$ent_qty = str_replace(array("||||","|||","||"),"|",$row->EntitlementQty);	
								
								$ent_prodcode = str_replace("'", "\'",$row->EntitlementProductCode);
								$ent_prodcode = str_replace("|", ";",$row->EntitlementProductCode);
								$ent_prodcode = str_replace(array("\r","\n"),"|",$row->EntitlementProductCode);
								$ent_prodcode = str_replace(array("||||","|||","||"),"|",$row->EntitlementProductCode);										
								
								$ent_proddesc = str_replace("'", "\'",$row->EntitlementProductDescription);
								$ent_proddesc = trim(stripslashes(str_replace("'", "\'",$row->EntitlementProductDescription)));
								$ent_proddesc = trim(stripslashes(str_replace("|", ";",$row->EntitlementProductDescription)));
								$ent_proddesc = trim(stripslashes(str_replace(array("\r","\n"),"|",$row->EntitlementProductDescription)));
								$ent_proddesc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$row->EntitlementProductDescription)));    
								$ent_proddesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $row->EntitlementProductDescription)));
								$ent_proddesc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $row->EntitlementProductDescription)));
								$ent_proddesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $row->EntitlementProductDescription)));		
								
								$entdet_qty = $row->EntitlementDetQty;
								$entdet_qty = str_replace("'", "\'",$row->EntitlementDetQty);
								$entdet_qty = str_replace("|", ";",$row->EntitlementDetQty);
								$entdet_qty = str_replace(array("\r","\n"),"|",$row->EntitlementDetQty);
								$entdet_qty = str_replace(array("||||","|||","||"),"|",$row->EntitlementDetQty);	
								
							    $entdet_price = $row->EntitlementDetEffPrice;
								$entdet_price = str_replace("'", "\'",$row->EntitlementDetEffPrice);
								$entdet_price = str_replace("|", ";",$row->EntitlementDetEffPrice);
								$entdet_price = str_replace(array("\r","\n"),"|",$row->EntitlementDetEffPrice);
								$entdet_price = str_replace(array("||||","|||","||"),"|",$row->EntitlementDetEffPrice);		
								
								$entdet_savings = $row->EntitlementDetSavings;
								$entdet_savings = str_replace("'", "\'",$row->EntitlementDetSavings);
								$entdet_savings = str_replace("|", ";",$row->EntitlementDetSavings);
								$entdet_savings = str_replace(array("\r","\n"),"|",$row->EntitlementDetSavings);
								$entdet_savings = str_replace(array("||||","|||","||"),"|",$row->EntitlementDetSavings);								
								
								$entdet_pmg = $row->EntitlementDetPMG;
								$entdet_pmg = str_replace("'", "\'",$row->EntitlementDetPMG);
								$entdet_pmg = str_replace("|", ";",$row->EntitlementDetPMG);
								$entdet_pmg = str_replace(array("\r","\n"),"|",$row->EntitlementDetPMG);
								$entdet_pmg = str_replace(array("||||","|||","||"),"|",$row->EntitlementDetPMG);	
								
								$promo_isplusplan = $row->IsPlusPlan;
								$promo_isplusplan = str_replace("'", "\'",$row->IsPlusPlan);
								$promo_isplusplan = str_replace("|", ";",$row->IsPlusPlan);
								$promo_isplusplan = str_replace(array("\r","\n"),"|",$row->IsPlusPlan);
								$promo_isplusplan = str_replace(array("||||","|||","||"),"|",$row->IsPlusPlan);
					...
					else if ($uType == 6) //multiline - buyin
					{
						...
						if ($multiline->num_rows)
						{
							while ($row = $multiline->fetch_object())
							{
								...
								$mb_promocode = str_replace("'", "\'",$row->PromoCode);	
								$mb_promocode = str_replace("|", ";",$row->PromoCode);
								$mb_promocode = str_replace(array("\r","\n"),"|",$row->PromoCode);
								$mb_promocode = str_replace(array("||||","|||","||"),"|",$row->PromoCode);
								
								$mb_promodesc = str_replace("'", "\'",$row->PromoDescription);
								$mb_promodesc = trim(stripslashes(str_replace("'", "\'",$row->PromoDescription)));
								$mb_promodesc = trim(stripslashes(str_replace("|", ";",$row->PromoDescription)));
								$mb_promodesc = trim(stripslashes(str_replace(array("\r","\n"),"|",$row->PromoDescription)));
								$mb_promodesc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$row->PromoDescription)));    
								$mb_promodesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $row->PromoDescription)));
								$mb_promodesc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $row->PromoDescription)));
								$mb_promodesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $row->PromoDescription)));	
								
								$mb_promosdate = $row->PromoStartDate;
								$mb_promosdate = str_replace("'", "\'",$row->PromoStartDate);
								$mb_promosdate = str_replace("|", ";",$row->PromoStartDate);
								$mb_promosdate = str_replace(array("\r","\n"),"|",$row->PromoStartDate);
								$mb_promosdate = str_replace(array("||||","|||","||"),"|",$row->PromoStartDate);		
							
								$mb_promoedate = $row->PromoEndDate;
								$mb_promoedate = str_replace("'", "\'",$row->PromoEndDate);
								$mb_promoedate = str_replace("|", ";",$row->PromoEndDate);
								$mb_promoedate = str_replace(array("\r","\n"),"|",$row->PromoEndDate);
								$mb_promoedate = str_replace(array("||||","|||","||"),"|",$row->PromoEndDate);
									
								$mb_buyintype = $row->BuyinTypeID;
								$mb_buyintype = str_replace("'", "\'",$row->BuyinTypeID);
								$mb_buyintype = str_replace("|", ";",$row->BuyinTypeID);
								$mb_buyintype = str_replace(array("\r","\n"),"|",$row->BuyinTypeID);
								$mb_buyintype = str_replace(array("||||","|||","||"),"|",$row->BuyinTypeID);
						
								
								$mb_buyinminqty = $row->BuyinMinQty;
								$mb_buyinminqty = str_replace("'", "\'",$row->BuyinMinQty);
								$mb_buyinminqty = str_replace("|", ";",$row->BuyinMinQty);
								$mb_buyinminqty = str_replace(array("\r","\n"),"|",$row->BuyinMinQty);
								$mb_buyinminqty = str_replace(array("||||","|||","||"),"|",$row->BuyinMinQty);	
						
								$mb_buyinminamt = $row->BuyinMinAmt;
								$mb_buyinminamt = str_replace("'", "\'",$row->BuyinMinAmt);
								$mb_buyinminamt = str_replace("|", ";",$row->BuyinMinAmt);
								$mb_buyinminamt = str_replace(array("\r","\n"),"|",$row->BuyinMinAmt);
								$mb_buyinminamt = str_replace(array("||||","|||","||"),"|",$row->BuyinMinAmt);	
						
								$mb_buyinplevel = $row->BuyinProductLevelID;
								$mb_buyinplevel = str_replace("'", "\'",$row->BuyinProductLevelID);
								$mb_buyinplevel = str_replace("|", ";",$row->BuyinProductLevelID);
								$mb_buyinplevel = str_replace(array("\r","\n"),"|",$row->BuyinProductLevelID);
								$mb_buyinplevel = str_replace(array("||||","|||","||"),"|",$row->BuyinProductLevelID);									
								
								$mb_buyinpcode = str_replace("'", "\'",$row->BuyinProductCode);
								$mb_buyinpcode = str_replace("'", "\'",$row->BuyinProductCode);
								$mb_buyinpcode = str_replace("|", ";",$row->BuyinProductCode);
								$mb_buyinpcode = str_replace(array("\r","\n"),"|",$row->BuyinProductCode);
								$mb_buyinpcode = str_replace(array("||||","|||","||"),"|",$row->BuyinProductCode);
							
								$mb_buyinpdesc = str_replace("'", "\'",$row->BuyinProductDescription);
								$mb_buyinpdesc = trim(stripslashes(str_replace("'", "\'",$row->BuyinProductDescription)));
								$mb_buyinpdesc = trim(stripslashes(str_replace("|", ";",$row->BuyinProductDescription)));
								$mb_buyinpdesc = trim(stripslashes(str_replace(array("\r","\n"),"|",$row->BuyinProductDescription)));
								$mb_buyinpdesc = trim(stripslashes(str_replace(array("||||","|||","||"),"|",$row->BuyinProductDescription)));    
								$mb_buyinpdesc = trim(stripslashes(str_replace(array("-", ":", ".", "/"), array('-', ':', '.', '/'), $row->BuyinProductDescription)));
								$mb_buyinpdesc = trim(stripslashes(str_replace(array("'", "*", "'", "#"), array('', '*',' ','#'), $row->BuyinProductDescription)));
								$mb_buyinpdesc = trim(stripslashes(str_replace(array("'", "*", ".", "/"), array('', '*','.','/'), $row->BuyinProductDescription)));			
								
								$mb_buyinreqtype = $row->BuyinPurchaseReqTypeID;
								$mb_buyinreqtype = str_replace("'", "\'",$row->BuyinPurchaseReqTypeID);
								$mb_buyinreqtype = str_replace("|", ";",$row->BuyinPurchaseReqTypeID);
								$mb_buyinreqtype = str_replace(array("\r","\n"),"|",$row->BuyinPurchaseReqTypeID);
								$mb_buyinreqtype = str_replace(array("||||","|||","||"),"|",$row->BuyinPurchaseReqTypeID);	
								
								$mb_buyinleveltype = $row->BuyinLevelTypeID;
								$mb_buyinleveltype = str_replace("'", "\'",$row->BuyinLevelTypeID);
								$mb_buyinleveltype = str_replace("|", ";",$row->BuyinLevelTypeID);
								$mb_buyinleveltype = str_replace(array("\r","\n"),"|",$row->BuyinLevelTypeID);
								$mb_buyinleveltype = str_replace(array("||||","|||","||"),"|",$row->BuyinLevelTypeID);	
						
								$ml_isplusplan = $row->IsPlusPlan;
								$ml_isplusplan = str_replace("'", "\'",$row->IsPlusPlan);
								$ml_isplusplan = str_replace("|", ";",$row->IsPlusPlan);
								$ml_isplusplan = str_replace(array("\r","\n"),"|",$row->IsPlusPlan);
								$ml_isplusplan = str_replace(array("||||","|||","||"),"|",$row->IsPlusPlan);
								...
								if ($buyin_prod->num_rows)
								{
									...
									{
										//insert promo header
										$rs_promoid = $sp->spInsertPromoHeader_upload($database, $promo_code, $promo_desc, $promo_sdate, $promo_edate, 2, $session->emp_id, $promo_isplusplan);
										if($rs_promoid->num_rows)
										{
											while($row = $rs_promoid->fetch_object())
											{
