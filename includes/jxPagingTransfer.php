...
$query = $sp->spSelectTransferCount($database, $vSearch);
	...
	elseif ($maxPage>=1 AND $type=='con') 
	{
		echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1' class='tab'>
                    <tr align='center'>
					  ...
					  <td width='15%' class='bdiv_r'><b>Destination Warehouses</b></td>
		...
		$query = $sp->spSelectTransfer($database, $offset, $RPP,trim($vSearch)) ;
		...
		while($row = $query->fetch_object()) 
		{
		  ...
		  echo "<tr align='center' class='$alt'>
					  <td height='20' class='borderBR'><a href='index.php?pageid=29.1&tid=$id' class='txtnavgreenlink'>$row->TxnNo</a></td>
					  <td class='borderBR'>$row->DocNo</td>
					  <td class='borderBR'>$row->TxnDate</td>
					  <td class='borderBR'>$warehouse</td>
					  <td class='borderBR'>$row->DestinationWarehouse</td>
					  <td class='borderBR'>$row->StatusName</td>
...
else if (($num <= 0) && ($type == 'con'))
{
	echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1' class='tab'>
	    <tr align='center'>
	      <td width='20%' class='bdiv_r'><b> Transaction Number</b></td>
	      <td width='12%' class='bdiv_r'><b>Document Number</b></td>
		  <td width='12%' class='bdiv_r'><b>Transaction Date</b></td>
	      <td width='12%' class='bdiv_r'><b>Source Warehouse</b></td>
	      <td width='12%' class='bdiv_r'><b>Destination Warehouse</b></td>
	      <td width='12%' class='bdiv_r'><b>Status</b></td>
	      
	    </tr>
	    <tr><td colspan='7' height='30' class='borderBR'><div align='center'><span class='txtredsbold'>No record(s) to display.</span></div></tr>
	    </table>";
}
