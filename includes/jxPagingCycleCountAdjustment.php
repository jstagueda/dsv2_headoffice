...
$query = $sp->spSelectCycleAdjustmentCount($database, $vSearch);
...
*/
		echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1' class='tab'>
                    <tr align='center'>
                      <td width='20%' class='bdiv_r'><b>Transaction ID</b></td>
                      <td width='20%' class='bdiv_r'><b>Document Number</b></td>
					  <td width='20%' class='bdiv_r' height='20'><b>Transaction Date</b></td>
                      <td width='20%' class='bdiv_r'><b>Warehouse</b></td>
                      <td ><b>Status</b></td>
                    </tr>";
		...
		$query = $sp->spSelectCycleCountAdjustment($database, $offset, $RPP, $vSearch);
		$num=$query->num_rows;
		...
		while($row = $query->fetch_object()) {
		  ...
		  echo "<tr align='center' class='$alt'>
					  ...
					  <a href='index.php?pageid=59.1&tid=$id' class='txtnavgreenlink'>$row->TransNo</a></td>
					  <td width='20%' class='borderBR'> $docno </td>
					  <td width='20%'  class='borderBR'> $txndate </td>
					  <td width='20%' class='borderBR'>$warehouse </td>
