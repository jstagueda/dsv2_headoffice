...
$query = $sp->spSelectInvCntCount($database, $vSearch);
...
*/
		...
		$query = $sp->spSelectRecordInvCount($database,$offset, $RPP, $vSearch);
		$num=$query->num_rows;
		...
		while($row = $query->fetch_object()) {
		  ...
		  echo "<tr align='center' class='$alt'>
					  ...
					  <a href='index.php?pageid=32.1&tid=$id' class='txtnavgreenlink'>$txnno</a></td>
