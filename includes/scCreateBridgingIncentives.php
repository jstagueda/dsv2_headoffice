...
if(isset($_POST['btnBigDelete'])){
	try
	{
		...
		$database->execute("delete from incentivespromoavailemnt where PromoIncentiveID =$_GET[ID]");
		...
		echo "<script language=JavaScript>
				opener.location.href = '../../index.php?pageid=201&msg=Successfully Updated promo.';
				window.close();
			 </script>";
	}
