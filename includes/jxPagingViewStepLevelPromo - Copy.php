	...
	elseif ($maxPage>=1 AND $type=='con') 
	{
		echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1'>
				<tr align='center' class='txtdarkgreenbold10 tab'>
					...
					<td width='10%' height='20' class='bdiv_r'><div align='center'>Start Date</div></td>
					<td width='10%' height='20' class='bdiv_r'><div align='center'>End Date</div></td>
					<td width='10%' height='20'><div align='center' class='padr5'>Date Created</div></td>
				</tr>";
                    
		//Get all the rows
		$query = $sp->spSelectPromo2($database, $offset, $RPP, 4, $scodedesc, $sprodcode, 0);
		$num = $query->num_rows;
...
else if (($num <= 0) && ($type == 'con'))
{
	echo "<table width='100%'  border='0' cellpadding='0' cellspacing='1' class='txtdarkgreenbold10 tab'>
		<tr align='center'>
			<td width='10%' height='20' class='bdiv_r'><div align='left' class='padl5'>Promo Code</div></td>
			<td width='15%' height='20' class='bdiv_r'><div align='left' class='padl5'>Promo Description</div></td>			
			<td width='10%' height='20' class='bdiv_r'><div align='center' class='padr5'>Start Date</div></td>
			<td width='10%' height='20' class='bdiv_r'><div align='center' class='padr5'>End Date</div></td>
			<td width='10%' height='20'><div align='center' class='padr5'>Date Created</div></td>
		</tr>
