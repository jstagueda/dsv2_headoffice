...
$tpi->insertAppliedPromoApplicationFunction($sales_order_session_id, $promo_id, base64_encode(serialize('apply_overlay_promo_entitlements('.$promo_id.', \''.$_GET['applicable_overlay_promo_entitlement_details_quantities'].'\');')));
...
if($rsApplicableOverlayPromoEntitlements->num_rows) {
  ...
  while($field=$rsApplicableOverlayPromoEntitlements->fetch_object()) {        
    ...
    $applied_overlay_promo_entitlements_html.='
    <tr>
...
echo $applied_overlay_promo_entitlements_html;
