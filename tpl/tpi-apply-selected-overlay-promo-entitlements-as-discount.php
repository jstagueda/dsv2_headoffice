...
$tpi->insertAppliedPromoApplicationFunction($sales_order_session_id, $promo_id, base64_encode(serialize('apply_selected_overlay_promo_entitlements_as_discount('.$promo_id.', \''.$_GET['applicable_overlay_promo_entitlement_details_ids'].'\', \''.$_GET['applicable_overlay_promo_entitlement_details_quantities'].'\');')));
